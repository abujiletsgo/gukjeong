...
// Live mode: /api/news/topics (pre-clustered topics with AI analysis)
...
import LiveTopicCard from '@/components/news/LiveTopicCard';
...
export default function NewsPageClient({ events, outlets }: NewsPageClientProps) {
  ...
  /* ================================================================
     DEMO MODE computed values (hooks must stay before any conditional return)
     ================================================================ */
  ...
  /* ================================================================
     ...
     ================================================================ */
  if (!isDemo) {
    // Derive KPI values from topicsData
