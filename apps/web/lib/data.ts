...
import type { President, FiscalYearly, FiscalBySector, AuditFlag, AuditLink, AuditContract, AuditTimelineItem, DepartmentScore, NationalAgenda, CampaignPledge, ReportCardMetric, KeyEvent, Bill, NewsEvent, MediaOutlet, NewsArticle, PresidentComparisonMetrics, Legislator, ConsistencyItem } from './types';
  ...
  return [
    {
      ...
      real_case_example: '2019년 감사원은 국토교통부 산하 한국도로공사의 연말 밀어내기 집행을 적발하여 287억 원 규모의 부당 집행을 확인했습니다. 12월에 발주한 도로 보수 공사 중 상당수가 이듬해 봄까지 착공하지 않은 "서류상 계약"이었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2020년 감사원은 방위사업청의 K-9 자주포 부품 조달 과정에서 특정 업체 집중 계약을 통한 128억 원 규모의 과다 지급을 적발했습니다. 경쟁 업체가 존재했음에도 기술 특수성을 명분으로 수의계약을 반복 체결한 사례였습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2021년 감사원은 환경부 산하 한국환경공단에서 특정 컨설팅 업체와 1,950만 원 단위의 계약을 8건 반복 체결한 사실을 적발했습니다. 합산 금액 1억 5,600만 원으로 공개경쟁입찰 대상이었으나 수의계약으로 처리한 위법 사항이었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2022년 감사원은 전국 17개 시도교육청의 연말 학교 시설 보수 사업을 감사하여 총 156억 원의 부당 집행을 적발했습니다. 공사 완료 전에 대금을 지급한 사례, 실제 공사 없이 서류만 처리한 사례 등이 포함되었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2023년 감사원은 과기정통부의 "디지털 뉴딜" 관련 사업에서 특정 SI 업체에 4년간 230억 원 규모의 계약이 집중된 사실을 적발했습니다. 해당 업체 출신 인사가 과기정통부 자문위원으로 활동하며 입찰 정보를 사전에 제공한 것으로 확인되었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2020년 감사원은 행정안전부의 정부통합전산센터에서 서버 장비 구매 시 1,900만 원 단위로 6건의 계약을 분할 체결한 사례를 적발했습니다. 합산 금액 1억 1,400만 원으로 공개경쟁입찰 대상이었으며, 관련 담당자 3명이 징계 처분을 받았습니다.',
      related_links: [
    ...
    // ===== 새로운 감사 플래그 (af-007 ~ af-016) =====
    {
      ...
      real_case_example: '2021년 감사원은 한국과학기술연구원(KIST)의 첨단 분석장비 구매 과정에서 해외 직구매가 대비 45% 높은 가격으로 국내 중개업체를 통해 구매한 사실을 적발하여 87억 원의 과다 지급을 확인했습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2022년 감사원은 행정안전부의 "차세대 전자정부 시스템" 사업이 7년간 520억 원을 투입하고도 완성률 25%에 머문 사실을 적발하여 사업 전면 재검토를 권고했습니다. 해당 사업은 결국 백지화되었고, 투입 예산은 매몰비용이 되었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2023년 감사원은 보건복지부 산하 국민건강보험공단의 연말 의료장비 구매 과정에서 42억 원 규모의 밀어내기 집행을 적발했습니다. 구매한 MRI 장비 3대 중 1대는 설치 후 6개월간 가동되지 않았습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2019년 공정거래위원회는 군용 통신장비 납품 관련 4개 방산 업체의 입찰 담합을 적발하여 총 214억 원의 과징금을 부과했습니다. 7년간 43건의 입찰에서 순환 낙찰 패턴이 확인되었으며, 업체 간 사전 가격 조율 증거가 확보되었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2022년 감사원은 농림축산식품부의 "스마트팜 혁신밸리" 사업에서 특정 업체가 시설 납품과 운영을 동시에 수주하여 이해충돌이 발생한 사례를 적발했습니다. 해당 업체는 자사 장비를 기준으로 시설을 설계하여 타 업체 참여를 원천 차단했습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2021년 감사원은 문화체육관광부의 한류 홍보 사업에서 특정 기획사에 수의계약 한도 직하 금액으로 9건의 계약을 분할 체결한 사실을 적발했습니다. 합산 1억 7,100만원으로 해당 기획사 대표가 전직 문체부 공무원의 지인이었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2020년 감사원은 해양수산부의 해양과학 관측장비 구매에서 노르웨이 제조사 직구매가 대비 55% 높은 가격으로 국내 대리점을 통해 구매한 사실을 적발하여 42억 원의 과다 지급을 확인했습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2023년 감사원은 교육부의 "에듀테크 혁신 플랫폼" 사업이 4년간 180억 원을 투입하고도 일선 학교 보급률 8%에 그친 사실을 적발했습니다. 현장 교사의 의견 수렴 없이 추진되어 실제 수업에 활용할 수 없는 시스템이 만들어졌습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2022년 감사원은 산업통상자원부의 "에너지 기술개발" 사업에서 12월에 급하게 선정된 연구과제 35건 중 18건이 이듬해 3월까지 실질적 연구를 시작하지 않은 사실을 적발했습니다. 이 중 5건은 결국 중도 포기되어 8억 원이 낭비되었습니다.',
      related_links: [
    ...
    },
    {
      ...
      real_case_example: '2023년 국민권익위원회는 기획재정부 전직 과장급 공무원 3명이 퇴직 후 동일 회계법인에 취업하여 기재부 관련 용역 12건(총 96억 원)을 수주한 사례를 조사하여 공직자윤리법 위반으로 고발했습니다. 이 중 2명은 취업 제한 기간 내 취업으로 형사처벌을 받았습니다.',
      related_links: [
