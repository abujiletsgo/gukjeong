...
export function getSubSectorData(sector: string, year: number = 2026): SubSectorData[] {
  ...
  const data: Record<string, SubSectorData[]> = {
    '보건·복지·고용': [
      { sector: '보건·복지·고용', sub_sector: '기초연금', amount: 23.8, percentage: 8.8 },
      { sector: '보건·복지·고용', sub_sector: '건강보험 지원', amount: 12.5, percentage: 4.6 },
      { sector: '보건·복지·고용', sub_sector: '아동수당·보육', amount: 9.2, percentage: 3.4 },
      { sector: '보건·복지·고용', sub_sector: '기초생활보장', amount: 15.3, percentage: 5.7 },
      { sector: '보건·복지·고용', sub_sector: '국민연금 지원', amount: 8.7, percentage: 3.2 },
      { sector: '보건·복지·고용', sub_sector: '고용보험', amount: 14.2, percentage: 5.3 },
      { sector: '보건·복지·고용', sub_sector: '의료급여', amount: 11.8, percentage: 4.4 },
      { sector: '보건·복지·고용', sub_sector: '장애인 지원', amount: 6.3, percentage: 2.3 },
      { sector: '보건·복지·고용', sub_sector: '노인 돌봄', amount: 4.8, percentage: 1.8 },
      { sector: '보건·복지·고용', sub_sector: '기타 복지', amount: 162.5, percentage: 60.4 },
    ],
    '교육': [
      { sector: '교육', sub_sector: '지방교육재정교부금', amount: 67.2, percentage: 67.3 },
      { sector: '교육', sub_sector: '유아교육 지원', amount: 5.8, percentage: 5.8 },
      { sector: '교육', sub_sector: '고등교육 지원', amount: 12.3, percentage: 12.3 },
      { sector: '교육', sub_sector: '평생·직업교육', amount: 4.5, percentage: 4.5 },
      { sector: '교육', sub_sector: '학술연구 지원', amount: 6.2, percentage: 6.2 },
      { sector: '교육', sub_sector: '기타 교육', amount: 3.8, percentage: 3.8 },
    ],
    '국방': [
      { sector: '국방', sub_sector: '전력운영', amount: 28.5, percentage: 43.0 },
      { sector: '국방', sub_sector: '방위력 개선', amount: 22.8, percentage: 34.4 },
      { sector: '국방', sub_sector: '병력운영', amount: 10.2, percentage: 15.4 },
      { sector: '국방', sub_sector: '군사시설', amount: 3.1, percentage: 4.7 },
      { sector: '국방', sub_sector: '기타 국방', amount: 1.7, percentage: 2.6 },
    ],
    '일반·지방행정': [
      { sector: '일반·지방행정', sub_sector: '지방교부세', amount: 68.5, percentage: 56.6 },
      { sector: '일반·지방행정', sub_sector: '지방교부금', amount: 25.3, percentage: 20.9 },
      { sector: '일반·지방행정', sub_sector: '중앙행정', amount: 15.8, percentage: 13.0 },
      { sector: '일반·지방행정', sub_sector: '선거관리', amount: 1.5, percentage: 1.2 },
      { sector: '일반·지방행정', sub_sector: '기타 행정', amount: 10.0, percentage: 8.3 },
    ],
    '산업·중소기업·에너지': [
      { sector: '산업·중소기업·에너지', sub_sector: '중소기업 지원', amount: 12.5, percentage: 33.6 },
      { sector: '산업·중소기업·에너지', sub_sector: '에너지 전환', amount: 8.3, percentage: 22.3 },
      { sector: '산업·중소기업·에너지', sub_sector: '산업기술 R&D', amount: 6.8, percentage: 18.3 },
      { sector: '산업·중소기업·에너지', sub_sector: '무역·투자 촉진', amount: 4.2, percentage: 11.3 },
      { sector: '산업·중소기업·에너지', sub_sector: '소상공인 지원', amount: 3.8, percentage: 10.2 },
      { sector: '산업·중소기업·에너지', sub_sector: '기타', amount: 1.6, percentage: 4.3 },
    ],
    'R&D': [
      { sector: 'R&D', sub_sector: '기초과학', amount: 10.1, percentage: 29.9 },
      { sector: 'R&D', sub_sector: 'AI·반도체', amount: 8.5, percentage: 25.1 },
      { sector: 'R&D', sub_sector: '바이오·의료', amount: 5.2, percentage: 15.4 },
      { sector: 'R&D', sub_sector: '우주·항공', amount: 3.8, percentage: 11.2 },
      { sector: 'R&D', sub_sector: '에너지 R&D', amount: 2.5, percentage: 7.4 },
      { sector: 'R&D', sub_sector: '국방 R&D', amount: 2.2, percentage: 6.5 },
      { sector: 'R&D', sub_sector: '기타 R&D', amount: 1.5, percentage: 4.4 },
    ],
    '공공질서·안전': [
      { sector: '공공질서·안전', sub_sector: '경찰', amount: 12.8, percentage: 50.4 },
      { sector: '공공질서·안전', sub_sector: '소방', amount: 4.5, percentage: 17.7 },
      { sector: '공공질서·안전', sub_sector: '법원·검찰', amount: 4.2, percentage: 16.5 },
      { sector: '공공질서·안전', sub_sector: '교정', amount: 2.1, percentage: 8.3 },
      { sector: '공공질서·안전', sub_sector: '기타', amount: 1.8, percentage: 7.1 },
    ],
    'SOC': [
      { sector: 'SOC', sub_sector: '도로', amount: 8.5, percentage: 29.8 },
      { sector: 'SOC', sub_sector: '철도', amount: 7.2, percentage: 25.3 },
      { sector: 'SOC', sub_sector: '수자원', amount: 4.3, percentage: 15.1 },
      { sector: 'SOC', sub_sector: '항만·공항', amount: 3.8, percentage: 13.3 },
      { sector: 'SOC', sub_sector: '주택', amount: 3.2, percentage: 11.2 },
      { sector: 'SOC', sub_sector: '기타 SOC', amount: 1.5, percentage: 5.3 },
    ],
    '농림·수산·식품': [
      { sector: '농림·수산·식품', sub_sector: '농업 직불금', amount: 8.5, percentage: 34.3 },
      { sector: '농림·수산·식품', sub_sector: '수산업 지원', amount: 4.2, percentage: 16.9 },
      { sector: '농림·수산·식품', sub_sector: '식품 안전', amount: 2.8, percentage: 11.3 },
      { sector: '농림·수산·식품', sub_sector: '농촌 개발', amount: 5.3, percentage: 21.4 },
      { sector: '농림·수산·식품', sub_sector: '기타', amount: 4.0, percentage: 16.1 },
    ],
    '환경': [
      { sector: '환경', sub_sector: '수질 관리', amount: 3.8, percentage: 28.8 },
      { sector: '환경', sub_sector: '대기 관리', amount: 2.5, percentage: 18.9 },
      { sector: '환경', sub_sector: '폐기물 처리', amount: 2.8, percentage: 21.2 },
      { sector: '환경', sub_sector: '자연환경 보전', amount: 2.1, percentage: 15.9 },
      { sector: '환경', sub_sector: '기후변화 대응', amount: 1.2, percentage: 9.1 },
      { sector: '환경', sub_sector: '기타', amount: 0.8, percentage: 6.1 },
    ],
    '문화·체육·관광': [
      { sector: '문화·체육·관광', sub_sector: '문화예술', amount: 3.2, percentage: 32.7 },
      { sector: '문화·체육·관광', sub_sector: '관광 진흥', amount: 2.5, percentage: 25.5 },
      { sector: '문화·체육·관광', sub_sector: '체육', amount: 2.1, percentage: 21.4 },
      { sector: '문화·체육·관광', sub_sector: '문화재', amount: 1.2, percentage: 12.2 },
      { sector: '문화·체육·관광', sub_sector: '기타', amount: 0.8, percentage: 8.2 },
    ],
  };
