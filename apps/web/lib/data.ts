...
import type { President, FiscalYearly, FiscalBySector, SubSectorData, AuditFlag, AuditLink, AuditContract, AuditTimelineItem, DepartmentScore, NationalAgenda, CampaignPledge, ReportCardMetric, KeyEvent, Bill, NewsEvent, MediaOutlet, NewsArticle, PresidentComparisonMetrics, Legislator, ConsistencyItem } from './types';
  ...
  return [
    {
      ...
      contracts: [
        ...
        { title: 'GTX-B 노선 설계 용역 추가 계약', amount: 1500000000, vendor: '(주)한국엔지니어링', date: '2025-12-22', method: '수의계약' },
        { title: '국토정보 플랫폼 고도화 사업', amount: 1200000000, vendor: '(주)지오시스템즈', date: '2025-12-26', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: 'K-2 전차 포탑 제어장치 납품', amount: 6200000000, vendor: '(주)한국방산기술', date: '2025-10-22', method: '수의계약' },
        { title: '군 통합 통신체계 유지보수', amount: 5300000000, vendor: '(주)한국방산기술', date: '2025-11-08', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '수질오염 측정장비 유지보수 (2차)', amount: 19500000, vendor: '(주)그린솔루션', date: '2025-06-20', method: '수의계약' },
        { title: '환경모니터링 소프트웨어 업그레이드', amount: 19700000, vendor: '(주)그린솔루션', date: '2025-09-10', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: 'AI 디지털 교과서 플랫폼 구축', amount: 620000000, vendor: '(주)에듀테크코리아', date: '2025-12-10', method: '수의계약' },
        { title: '학교 급식시설 현대화 사업 (3차)', amount: 480000000, vendor: '(주)푸드시스템', date: '2025-12-19', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '공공데이터 개방 포털 고도화', amount: 850000000, vendor: '(주)IT컨설팅코리아', date: '2025-07-15', method: '제한경쟁입찰' },
        { title: '정부 클라우드 전환 컨설팅', amount: 680000000, vendor: '(주)IT컨설팅코리아', date: '2025-10-20', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '정부청사 네트워크 스위치 교체 (2차)', amount: 19200000, vendor: '(주)디지털행정', date: '2025-07-08', method: '수의계약' },
        { title: '정부청사 보안 장비 납품', amount: 18500000, vendor: '(주)디지털행정', date: '2025-09-15', method: '수의계약' },
      ],
      timeline: [
    ...
    // ===== 새로운 감사 플래그 (af-007 ~ af-016) =====
    {
      ...
      contracts: [
        ...
        { title: '양자 오류보정 시뮬레이터 라이선스', amount: 1200000000, vendor: '(주)퀀텀사이언스', date: '2025-09-15', method: '수의계약' },
        { title: '양자통신 암호화 테스트베드 구축', amount: 2300000000, vendor: '(주)퀀텀사이언스', date: '2025-11-02', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '스마트시티 데이터허브 구축 ISP', amount: 3800000000, vendor: '(주)도시데이터랩', date: '2025-06-25', method: '제한경쟁입찰' },
        { title: '스마트시티 사업 성과관리 컨설팅', amount: 1500000000, vendor: '(주)KPM컨설팅', date: '2025-09-30', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '보건소 디지털 건강관리 시스템 구축', amount: 2800000000, vendor: '(주)메디테크솔루션', date: '2025-12-15', method: '수의계약' },
        { title: '장애인복지관 무장애 환경 개선사업', amount: 2200000000, vendor: '(주)유니버설디자인', date: '2025-12-22', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '군 사이버방호센터 장비 납품', amount: 8500000000, vendor: '(주)방산테크', date: '2025-07-10', method: '경쟁입찰' },
        { title: '해군 함정 전자전 장비 정비', amount: 7200000000, vendor: '(주)코리아디펜스', date: '2025-09-25', method: '경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '축산 ICT 융합 시범사업 운영', amount: 1500000000, vendor: '(주)한국농업기술', date: '2025-07-20', method: '수의계약' },
        { title: '스마트 온실 환경제어 시스템 납품', amount: 1200000000, vendor: '(주)한국농업기술', date: '2025-10-05', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '국립박물관 특별전 VR 콘텐츠 제작', amount: 19500000, vendor: '(주)문화콘텐츠기획', date: '2025-04-22', method: '수의계약' },
        { title: '관광 홍보 SNS 캠페인 기획', amount: 18700000, vendor: '(주)문화콘텐츠기획', date: '2025-07-15', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '무인선박 운용 교육훈련 체계 구축', amount: 850000000, vendor: '(주)오션로보틱스', date: '2025-08-25', method: '수의계약' },
        { title: '해양 자율운항 테스트베드 구축', amount: 1500000000, vendor: '(주)오션로보틱스', date: '2025-11-10', method: '제한경쟁입찰' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '디지털 교과서 콘텐츠 변환 및 품질검증', amount: 3200000000, vendor: '(주)스마트러닝코리아', date: '2025-05-20', method: '제한경쟁입찰' },
        { title: 'AI 디지털 교과서 UX 재설계 컨설팅', amount: 1800000000, vendor: '(주)UX이노베이션', date: '2025-08-10', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '수소경제 핵심부품 국산화 지원', amount: 1800000000, vendor: '(주)그린하이드로젠', date: '2025-12-12', method: '수의계약' },
        { title: '중소기업 수출바우처 긴급 추가 지원', amount: 1600000000, vendor: '(주)글로벌비즈파트너스', date: '2025-12-20', method: '수의계약' },
      ],
      timeline: [
    ...
    },
    {
      ...
      contracts: [
        ...
        { title: '공공부문 재정건전성 평가 용역', amount: 3800000000, vendor: '(주)국제재정컨설팅', date: '2025-01-20', method: '수의계약' },
        { title: '디지털 예산관리 시스템 ISP 수립', amount: 4500000000, vendor: '(주)국제재정컨설팅', date: '2025-05-10', method: '제한경쟁입찰' },
      ],
      timeline: [
