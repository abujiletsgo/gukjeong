...
export function getSubSectorData(sector: string, year: number = 2026): SubSectorData[] {
  ...
  const data: Record<string, SubSectorData[]> = {
    ...
    '교육': [
      { sector: '교육', sub_sector: '교직원 인건비 (교사·행정직)', amount: 35.2, percentage: 35.3, description: '전국 초중고 교사 약 45만명과 교육행정직 인건비. 교육 예산의 가장 큰 항목으로, 교사 급여·수당·퇴직금이 포함됩니다.' },
      { sector: '교육', sub_sector: '학교 운영비', amount: 8.5, percentage: 8.5, description: '전국 약 12,000개 초중고의 냉난방, 급식 보조, 교재교구 구입, 정보화 장비 등 학교 일상 운영 경비입니다.' },
      { sector: '교육', sub_sector: '학교 시설 신축·보수', amount: 6.8, percentage: 6.8, description: '노후 학교 리모델링, 신설 학교 건축, 내진 보강, 석면 제거 등 시설 투자입니다. 학생 수 감소에도 시설 투자는 꾸준합니다.' },
      { sector: '교육', sub_sector: '무상급식·교복 지원', amount: 4.5, percentage: 4.5, description: '초중고 무상급식 재료비와 일부 시·도의 무상교복 지원 비용입니다.' },
      { sector: '교육', sub_sector: '방과후학교·돌봄', amount: 3.2, percentage: 3.2, description: '초등돌봄교실 운영, 방과후학교 프로그램 지원 비용입니다. 맞벌이 가정의 돌봄 공백을 메웁니다.' },
      { sector: '교육', sub_sector: '특수교육·교육복지', amount: 2.8, percentage: 2.8, description: '장애학생 특수교육 지원, 교육복지 우선지원사업(저소득층 학생 지원) 등입니다.' },
      { sector: '교육', sub_sector: '시·도 교육청 자체 사업', amount: 6.2, percentage: 6.2, description: '17개 시·도 교육청이 자체적으로 기획·운영하는 사업입니다. 교육청별로 사용처가 다릅니다.' },
  ...
  return [
    {
      ...
      target_id: '국토교통부',
      detail: { '4분기_지출_비율': 62.3, '4분기_지출액': 4500000000, '연간_총지출': 7222222222, '연도': 2025 },
      evidence: { '기준치': '40%', '실제값': '62.3%', '설명': '국토교통부의 2025년 4분기(10~12월) 지출이 연간의 62.3%를 차지합니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '국방부',
      detail: { '업체명': '(주)한국방산기술', '집중도': 42.8, '계약_건수': 15 },
      evidence: { '기준치': '30%', '실제값': '42.8%' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '환경부',
      detail: { '관련_업체': [{ '업체명': '(주)그린솔루션', '분할_건수': 5 }] },
      evidence: { '기준치': '수의계약 한도(2000만원)의 80-100% 범위 계약 3건 이상' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '교육부',
      detail: { '4분기_지출_비율': 48.2, '연도': 2025 },
      evidence: { '기준치': '40%', '실제값': '48.2%' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '과학기술정보통신부',
      detail: { '업체명': '(주)IT컨설팅코리아', '집중도': 35.1, '계약_건수': 8 },
      evidence: { '기준치': '30%', '실제값': '35.1%' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '행정안전부',
      detail: { '관련_업체': [{ '업체명': '(주)디지털행정', '분할_건수': 4 }] },
      evidence: { '기준치': '수의계약 한도(2000만원)의 80-100% 범위 계약 3건 이상' },
    ...
    // ===== 새로운 감사 플래그 (af-007 ~ af-016) =====
    {
      ...
      target_type: 'department',
      target_id: '과학기술정보통신부',
      detail: { '품목명': '양자컴퓨팅 연구장비', '시장가격': 3200000000, '계약가격': 4800000000, '부풀림_비율': 50.0 },
      evidence: { '기준치': '시장가 대비 20% 초과', '실제값': '50.0% 초과', '설명': '양자컴퓨팅 연구장비 구매 가격이 시장가 대비 50% 높게 책정되었습니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '국토교통부',
      detail: { '사업명': '스마트시티 통합플랫폼 구축', '시작연도': 2021, '집행_예산': 28000000000, '진행률': 18, '당초_마감일': '2024-12-31' },
      evidence: { '기준치': '예산 집행률 대비 사업 진행률 30%p 이상 차이', '실제값': '예산 82% 집행, 진행률 18%', '설명': '5년차 사업이 예산의 82%를 소진했으나 실제 진행률은 18%에 불과합니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '보건복지부',
      detail: { '4분기_지출_비율': 51.7, '4분기_지출액': 8200000000, '연간_총지출': 15861120000, '연도': 2025 },
      evidence: { '기준치': '40%', '실제값': '51.7%', '설명': '보건복지부의 2025년 4분기(10~12월) 지출이 연간의 51.7%를 차지합니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '국방부',
      detail: { '담합_의심_업체': ['(주)한국방산기술', '(주)방산테크', '(주)코리아디펜스'], '패턴': '3개 업체가 순환 입찰, 낙찰률 각각 33%', '의심_계약_건수': 12 },
      evidence: { '기준치': '동일 업체 그룹의 순환 낙찰 패턴 3회 이상', '실제값': '12건의 계약에서 3개 업체 순환 낙찰', '설명': '3개 방산 업체가 12건의 입찰에서 돌아가며 낙찰받는 패턴이 발견되었습니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '농림축산식품부',
      detail: { '업체명': '(주)한국농업기술', '집중도': 33.5, '계약_건수': 11 },
      evidence: { '기준치': '30%', '실제값': '33.5%' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '문화체육관광부',
      detail: { '관련_업체': [{ '업체명': '(주)문화콘텐츠기획', '분할_건수': 6 }] },
      evidence: { '기준치': '수의계약 한도(2000만원)의 80-100% 범위 계약 3건 이상', '실제값': '6건의 수의계약 (1,850~1,990만원 범위)' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '해양수산부',
      detail: { '품목명': '해양환경 모니터링 무인선박 시스템', '시장가격': 1800000000, '계약가격': 2900000000, '부풀림_비율': 61.1 },
      evidence: { '기준치': '시장가 대비 20% 초과', '실제값': '61.1% 초과', '설명': '해양 모니터링 무인선박 구매가가 시장가 대비 61% 높게 책정되었습니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '교육부',
      detail: { '사업명': 'AI 디지털 교과서 플랫폼', '시작연도': 2022, '집행_예산': 15000000000, '진행률': 22, '당초_마감일': '2025-06-30' },
      evidence: { '기준치': '예산 집행률 대비 사업 진행률 30%p 이상 차이', '실제값': '예산 75% 집행, 진행률 22%', '설명': '4년차 사업이 예산의 75%를 소진했으나 실제 진행률은 22%에 불과합니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '산업통상자원부',
      detail: { '4분기_지출_비율': 46.8, '4분기_지출액': 5600000000, '연간_총지출': 11965811965, '연도': 2025 },
      evidence: { '기준치': '40%', '실제값': '46.8%', '설명': '산업통상자원부의 2025년 4분기(10~12월) 지출이 연간의 46.8%를 차지합니다.' },
    ...
    },
    {
      ...
      target_type: 'department',
      target_id: '기획재정부',
      detail: { '인물명': 'K 전 국장', '전직_직위': '기획재정부 재정관리국장', '현재_소속': '(주)국제재정컨설팅', '퇴직일': '2024-03-31', '첫_계약일': '2024-09-15', '퇴직후_수주_건수': 5, '총_수주액': 18500000000 },
      evidence: { '기준치': '퇴직 후 2년 이내 관련 기업 취업 및 계약 수주', '실제값': '퇴직 6개월 후 취업, 이후 5건 185억 원 수주', '설명': '기획재정부 전 국장급 공무원이 퇴직 6개월 만에 재정 컨설팅 업체에 취업하고, 해당 업체가 기재부 계약 5건을 수주했습니다.' },
...
const BILLS_DATA: Bill[] = [
  {
    ...
    co_sponsors: [
      { name: '주호영', party: '국민의힘', district: '대구 수성구갑', role: '대표발의', legislator_id: 'leg-020' },
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '이수진', party: '더불어민주당', district: '서울 동작구을', role: '대표발의', legislator_id: 'leg-006' },
      ...
      { name: '노웅래', party: '더불어민주당', district: '서울 마포구갑', role: '공동발의', legislator_id: 'leg-005' },
      { name: '한정애', party: '더불어민주당', district: '서울 강북구을', role: '공동발의', legislator_id: 'leg-004' },
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '김성환', party: '더불어민주당', district: '서울 노원구병', role: '대표발의', legislator_id: 'leg-009' },
      { name: '위성곤', party: '더불어민주당', district: '제주 서귀포시', role: '공동발의' },
      { name: '이개호', party: '더불어민주당', district: '전남 담양·함평·영광·장성', role: '공동발의', legislator_id: 'leg-008' },
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '한정애', party: '더불어민주당', district: '서울 강북구을', role: '대표발의', legislator_id: 'leg-004' },
      { name: '이수진', party: '더불어민주당', district: '서울 동작구을', role: '공동발의', legislator_id: 'leg-006' },
      { name: '강은미', party: '정의당', district: '비례대표', role: '공동발의' },
      { name: '이탄희', party: '더불어민주당', district: '경기 용인시병', role: '공동발의' },
  ...
  },
  {
    ...
    co_sponsors: [
      ...
      { name: '진성준', party: '더불어민주당', district: '서울 강북구갑', role: '공동발의', legislator_id: 'leg-012' },
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '노웅래', party: '더불어민주당', district: '서울 마포구갑', role: '대표발의', legislator_id: 'leg-005' },
  ...
  },
  {
    ...
    co_sponsors: [
      ...
      { name: '박성중', party: '국민의힘', district: '서울 서초구갑', role: '공동발의', legislator_id: 'leg-021' },
  ...
  },
  {
    ...
    co_sponsors: [
      ...
      { name: '김민석', party: '더불어민주당', district: '인천 계양구을', role: '공동발의', legislator_id: 'leg-001' },
      { name: '박주민', party: '더불어민주당', district: '서울 은평구갑', role: '공동발의' },
      { name: '한민수', party: '더불어민주당', district: '서울 영등포구갑', role: '공동발의', legislator_id: 'leg-032' },
      { name: '전현희', party: '더불어민주당', district: '서울 강남구병', role: '공동발의', legislator_id: 'leg-007' },
      { name: '노웅래', party: '더불어민주당', district: '서울 마포구갑', role: '공동발의', legislator_id: 'leg-005' },
    ],
    bill_timeline: [
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '소병훈', party: '더불어민주당', district: '경기 광주시갑', role: '대표발의', legislator_id: 'leg-011' },
      { name: '진성준', party: '더불어민주당', district: '서울 강북구갑', role: '공동발의', legislator_id: 'leg-012' },
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '전현희', party: '더불어민주당', district: '서울 강남구병', role: '대표발의', legislator_id: 'leg-007' },
      ...
      { name: '오영환', party: '더불어민주당', district: '비례대표', role: '공동발의', legislator_id: 'leg-010' },
    ],
    bill_timeline: [
  ...
  },
  {
    ...
    co_sponsors: [
      { name: '박성중', party: '국민의힘', district: '서울 서초구갑', role: '대표발의', legislator_id: 'leg-021' },
...
const LEGISLATORS_DATA: Legislator[] = [
  // ── 더불어민주당 (15명) ──
  {
    ...
    age: 48,
    gender: '남',
    career_summary: '인천 계양구을 보궐선거 당선 (이재명 대통령 당선에 따른 공석)',
    consistency_details: [
...
const SECTOR_DETAILS: Record<string, SectorDetail> = {
  'health-welfare': {
    ...
    percentage: 37.0,
    yoy_change: 7.5,
    description: '국민의 건강, 생활 안정, 일자리를 지원하는 예산입니다. 정부 전체 예산의 37%로 가장 큰 비중을 차지합니다.',
    why_it_matters: '기초연금, 건강보험, 아동수당, 고용보험 등 대부분의 국민이 직접 혜택을 받는 분야입니다. 고령화와 저출산으로 매년 지출이 증가하고 있어 재정 지속가능성이 핵심 과제입니다.',
    who_benefits: '65세 이상 노인 (기초연금), 영유아 가정 (아동수당·보육), 저소득층 (기초생활보장), 실업자 (고용보험), 전 국민 (건강보험)',
    historical_trend: '2016년 120조 → 2026년 269조로 10년간 124% 증가. 고령화 속도(노인 인구 비율 15%→22%)에 따라 복지 지출이 급증하는 추세입니다.',
    controversy: '복지 확대 vs 재정 건전성 논쟁이 핵심입니다. "더 많은 복지가 필요하다"는 입장과 "이 속도면 재정이 감당 못한다"는 입장이 대립합니다.',
    related_ministry: '보건복지부, 고용노동부',
    sub_items: [
      {
        id: 'basic-pension',
        name: '기초연금',
        amount: 23.8,
        percentage: 8.8,
        description: '만 65세 이상 소득 하위 70%에게 매달 최대 32만원을 지급하는 제도입니다.',
        who_receives: '65세 이상 약 620만명 (소득 하위 70%)',
        how_it_works: '국민연금공단이 소득·재산을 심사하여 대상자를 선정하고, 매월 25일 본인 계좌로 입금합니다. 국비 75% + 지방비 25%로 분담합니다.',
        citizen_impact: '독거노인이나 저소득 어르신에게 월 32만원은 생활에 큰 도움입니다. 다만 물가 상승을 고려하면 실질 구매력은 매년 감소하고 있습니다.',
        real_example: '서울 종로구에 혼자 사시는 김순자 할머니(78세)는 국민연금 25만원과 기초연금 32만원, 합계 57만원으로 한 달을 생활합니다. 월세 20만원을 내면 생활비는 37만원입니다.',
        trend: '수급자가 매년 30~40만명씩 증가하고 있어 예산이 2019년 12조 → 2026년 24조로 두 배 증가했습니다.',
        issues: '국민연금과의 연계 문제: 국민연금을 열심히 냈더니 기초연금이 깎이는 역설이 있습니다. "성실 납부자가 손해"라는 비판이 있습니다.',
        related_laws: ['기초연금법'],
        breakdown: [
          { name: '기초연금 급여비', amount: 22.5, description: '수급자에게 직접 지급되는 연금 급여', recipient: '65세 이상 620만명' },
          { name: '기초연금 관리운영비', amount: 0.8, description: '국민연금공단의 심사·지급 업무 운영비', recipient: '국민연금공단' },
          { name: '기초연금 전산시스템', amount: 0.5, description: '소득·재산 심사 전산 시스템 유지보수', recipient: 'IT 업체' },
        ],
      },
      {
        id: 'health-insurance',
        ...
        amount: 12.8,
        percentage: 4.8,
        description: '국민건강보험의 재정 적자를 메우기 위해 정부가 보조하는 금액입니다. 건강보험료만으로는 의료비를 다 감당할 수 없어서 세금으로 추가 지원합니다.',
        who_receives: '국민건강보험공단 → 전체 건강보험 가입자 5,300만명에게 간접 혜택',
        how_it_works: '건강보험 재정이 부족할 때 정부가 보험료 예상 수입의 20%를 국고에서 지원합니다. 이 돈이 없으면 보험료가 크게 오르거나 보장 범위가 줄어듭니다.',
        citizen_impact: '이 지원이 없으면 건강보험료가 약 20% 더 올라야 합니다. 월 보험료 15만원 내는 직장인이라면 약 3만원이 추가되는 셈입니다.',
        real_example: '대장내시경 검사비 15만원 중 건강보험이 10만원을 부담하고 본인은 5만원만 냅니다. 정부 지원이 줄면 본인 부담이 8만원까지 오를 수 있습니다.',
        trend: '고령화와 의료기술 발전으로 건보 지출이 매년 8~10%씩 증가. 정부 지원도 2019년 8조 → 2026년 13조로 증가했습니다.',
        issues: '건보 재정 고갈 우려: 2028년이면 적립금이 바닥날 수 있다는 전망이 있습니다. 보험료를 올릴지, 보장을 줄일지가 핵심 쟁점입니다.',
        related_laws: ['국민건강보험법'],
        breakdown: [
          { name: '건강보험 국고지원금', amount: 10.5, description: '보험료 수입의 20%에 해당하는 법정 지원금', recipient: '국민건강보험공단' },
          { name: '건강보험 기반안정화', amount: 1.5, description: '건강보험 재정 안정을 위한 추가 지원', recipient: '국민건강보험공단' },
          { name: '의료급여 국고부담', amount: 0.8, description: '기초생활수급자 등 의료급여 대상자 지원', recipient: '저소득층 150만명' },
        ],
      },
      {
        ...
        amount: 10.2,
        percentage: 3.8,
        description: '어린이집 보육료 지원, 아동수당(만 8세 미만 월 10만원), 양육수당 등을 포함합니다. 저출산 대응의 핵심 예산입니다.',
        who_receives: '만 0~7세 아동 약 320만명과 그 가정, 어린이집 4만여 곳',
        how_it_works: '아동수당은 만 8세 미만 모든 아동에게 매월 10만원이 부모 계좌로 자동 입금됩니다. 어린이집 보육료는 바우처(아이행복카드)로 지원되어 부모가 어린이집에 카드를 결제합니다.',
        citizen_impact: '맞벌이 부부에게 어린이집 보육료 월 50~100만원 지원은 실질적인 도움입니다. 아동수당 10만원은 기저귀·분유 정도의 금액이지만 없는 것보다는 낫다는 평가입니다.',
        real_example: '경기 성남시의 박지영 씨(34세)는 3살 딸을 어린이집에 보냅니다. 보육료 월 51만원은 정부가 전액 지원하고, 아동수당 10만원도 받습니다. 이 지원이 없었다면 경력단절을 고민했을 것이라고 합니다.',
        trend: '아동수당 도입(2018년) 이후 보육 예산이 꾸준히 증가했으나, 출생아 수 감소(2015년 44만명 → 2025년 22만명)로 보육료 지원 대상은 줄고 있습니다.',
        issues: '저출산 해결 효과가 미미하다는 비판이 있습니다. 현금성 지원만으로는 출산율이 오르지 않고, 주거·고용 안정이 더 중요하다는 의견이 많습니다.',
        related_laws: ['아동수당법', '영유아보육법'],
        breakdown: [
          { name: '어린이집 보육료 지원', amount: 5.8, description: '국공립·민간 어린이집 보육료 바우처 지원', recipient: '영유아 가정 200만 가구' },
          { name: '아동수당', amount: 3.2, description: '만 8세 미만 아동에게 매월 10만원 지급', recipient: '아동 320만명' },
          { name: '양육수당 및 기타', amount: 1.2, description: '가정양육수당, 첫만남이용권 등', recipient: '영유아 가정' },
        ],
      },
      {
        id: 'basic-livelihood',
        ...
        amount: 16.5,
        percentage: 6.1,
        description: '소득이 매우 낮아 기본적인 생활이 어려운 사람들에게 생계비, 주거비, 의료비, 교육비를 지원하는 최후의 안전망입니다.',
        who_receives: '기초생활수급자 약 260만명 (전체 인구의 약 5%)',
        how_it_works: '소득인정액(소득+재산 환산)이 기준 중위소득의 일정 비율 이하이면 신청 가능합니다. 생계급여(중위소득 32% 이하), 의료급여(40% 이하), 주거급여(48% 이하), 교육급여(50% 이하)로 나뉩니다.',
        citizen_impact: '생계급여는 1인가구 기준 월 약 71만원으로, 이것이 전부인 사람들에게는 생명줄입니다. 서울의 월세와 물가를 고려하면 여전히 부족하다는 지적이 많습니다.',
        real_example: '인천에 사는 이성호 씨(62세)는 당뇨와 허리 디스크로 일을 할 수 없습니다. 생계급여 71만원과 주거급여 33만원을 받아 원룸에서 생활합니다. 의료급여 덕분에 병원비 부담은 적지만, 생활비는 늘 빠듯합니다.',
        trend: '코로나 이후 수급자가 200만명 → 260만명으로 30% 증가. 기준 완화(부양의무자 기준 폐지 등)도 수급자 증가에 기여했습니다.',
        issues: '사각지대 문제: 소득이 기준선 바로 위인 "차상위계층"은 지원을 못 받습니다. 월소득 72만원이면 지원받고 73만원이면 못 받는 "절벽 효과"가 있습니다.',
        related_laws: ['국민기초생활보장법'],
        breakdown: [
          { name: '생계급여', amount: 7.8, description: '기본 생활비 직접 지급', recipient: '수급자 160만명' },
          { name: '의료급여', amount: 5.2, description: '의료비 전액 또는 대부분 지원', recipient: '수급자 150만명' },
          { name: '주거급여', amount: 2.5, description: '임차료 또는 주택 수선비 지원', recipient: '수급 가구 120만 가구' },
          { name: '교육급여', amount: 1.0, description: '입학금, 수업료, 교과서대 등 지원', recipient: '수급 가구 학생 50만명' },
        ],
      },
      {
        ...
        amount: 32.5,
        percentage: 12.1,
        description: '실업급여, 직업훈련, 고용장려금, 청년 일자리 사업 등 고용 관련 전체 예산입니다. 실직했을 때의 안전망이자 새 일자리를 찾는 데 도움을 줍니다.',
        who_receives: '실업자 (실업급여), 구직자 (직업훈련), 기업 (고용장려금), 청년 (청년 일자리 사업)',
        how_it_works: '고용보험에 가입된 근로자가 실직하면 실업급여를 신청할 수 있습니다. 근로복지공단이 자격을 심사하고, 이전 급여의 60%를 최대 9개월간 지급합니다. 직업훈련은 HRD-Net에서 신청합니다.',
        citizen_impact: '실업급여는 갑작스러운 실직 시 생계를 유지하면서 구직활동을 할 수 있게 해줍니다. 2025년 기준 1일 최대 6만6천원, 최소 6만1천원을 받습니다.',
        real_example: '대구의 김태영 씨(38세)는 자동차 부품회사에서 5년 일하다 구조조정으로 실직했습니다. 실업급여 월 160만원을 받으면서 국비 지원 코딩 교육을 수강했고, 6개월 후 IT 회사에 취업했습니다.',
        trend: '코로나 시기(2020~2021년) 실업급여 지출이 급증(12조 → 16조)했다가 현재는 안정세입니다. 플랫폼 노동자·프리랜서 등 고용보험 사각지대 해소가 과제입니다.',
        issues: '실업급여 반복 수급 문제: 일부에서 "실업급여 받으려고 일부러 해고되게 한다"는 비판이 있습니다. 반면 "고용보험료를 내고 있는데 당연한 권리"라는 반론도 있습니다.',
        related_laws: ['고용보험법', '고용정책기본법'],
        breakdown: [
          { name: '실업급여', amount: 12.8, description: '실직자에게 이전 급여의 60% 지급', recipient: '실업급여 수급자 연 180만명' },
          { name: '직업훈련', amount: 5.2, description: '국비 지원 직업교육·재취업 훈련', recipient: '구직자·재직자 연 200만명' },
          { name: '고용장려금', amount: 6.5, description: '기업의 신규 채용·고용 유지에 대한 장려금', recipient: '중소기업 20만 곳' },
          { name: '청년 일자리 사업', amount: 8.0, description: '청년내일채움공제, 청년인턴, 디지털 일자리 등', recipient: '청년(만 15~34세) 약 50만명' },
        ],
      },
      {
        ...
        amount: 5.8,
        percentage: 2.2,
        description: '장애인 연금, 활동지원 서비스, 장애인 고용 촉진, 재활 서비스 등 장애인의 자립과 사회 참여를 돕는 예산입니다.',
        who_receives: '등록 장애인 약 265만명 및 그 가족',
        how_it_works: '장애인 등급(심한 장애/심하지 않은 장애)에 따라 장애인 연금, 활동지원 서비스(돌봄 도우미), 보조기기 지원 등을 받을 수 있습니다. 주민센터에서 신청하고 국민연금공단이 심사합니다.',
        citizen_impact: '중증 장애인에게 활동지원 서비스는 일상생활의 핵심입니다. 하루 몇 시간 도우미가 와서 식사, 이동, 위생 관리를 돕습니다. 이 서비스 없이는 집 밖으로 나가기 어려운 분이 많습니다.',
        real_example: '뇌병변 장애 1급인 서울 은평구의 최정민 씨(45세)는 매일 8시간 활동지원사의 도움을 받습니다. 출퇴근 이동, 식사 보조, 컴퓨터 사용 보조 등을 통해 디자인 프리랜서로 일하고 있습니다.',
        trend: '탈시설(시설에서 지역사회로) 정책으로 활동지원 예산이 매년 15~20% 증가하고 있습니다. 2019년 1.8조 → 2026년 5.8조로 3배 이상 증가.',
        issues: '활동지원 시간이 부족하다는 호소가 많습니다. 하루 24시간 돌봄이 필요한 중증 장애인도 12~16시간만 지원받아 나머지 시간은 가족이 감당해야 합니다.',
        related_laws: ['장애인복지법', '장애인활동지원법', '장애인연금법'],
        breakdown: [
          { name: '장애인 활동지원', amount: 2.8, description: '중증 장애인에게 돌봄 도우미 파견', recipient: '활동지원 이용자 12만명' },
          { name: '장애인 연금', amount: 1.2, description: '중증 장애인에게 월 최대 32만원 지급', recipient: '중증 장애인 37만명' },
          { name: '장애인 고용 지원', amount: 1.0, description: '장애인 의무고용, 직업재활, 보호작업장 운영', recipient: '취업 장애인 및 사업체' },
          { name: '재활·보조기기', amount: 0.8, description: '재활치료, 보조기기 지원, 장애인 편의시설', recipient: '장애인 265만명' },
        ],
      },
      {
        id: 'elderly-longterm-care',
        name: '노인장기요양보험',
        amount: 12.5,
        percentage: 4.6,
        description: '거동이 불편한 어르신에게 요양시설 입소나 방문 요양 서비스를 제공하는 제도입니다. 건강보험과 별도로 장기요양보험료를 내고 있습니다.',
        who_receives: '장기요양 등급 판정을 받은 어르신 약 110만명',
        how_it_works: '65세 이상 또는 노인성 질환이 있는 분이 국민건강보험공단에 등급 판정을 신청합니다. 1~5등급 판정을 받으면 시설 입소(1~2등급) 또는 재가 서비스(3~5등급, 방문 요양·주간보호 등)를 이용할 수 있습니다.',
        citizen_impact: '치매 부모를 모시는 가정에게 주간보호센터나 방문요양 서비스는 가족의 돌봄 부담을 크게 줄여줍니다. 없으면 가족 중 한 명이 직장을 그만두거나 사비로 월 200~300만원을 써야 합니다.',
        real_example: '부산의 이현수 씨(55세)는 치매 3등급인 어머니(82세)를 모시고 있습니다. 주 5일 주간보호센터(본인부담 월 35만원)를 이용하면서 직장 생활을 유지하고 있습니다. 이 서비스가 없었다면 퇴직해야 했을 것입니다.',
        trend: '수급자가 2016년 52만명 → 2026년 110만명으로 두 배 이상 증가. 초고령사회 진입으로 향후에도 급증할 전망입니다.',
        issues: '요양보호사 처우 문제: 월급 180~200만원으로 인력 부족이 심각합니다. 요양시설의 질적 수준 편차도 큰 과제입니다.',
        related_laws: ['노인장기요양보험법'],
        breakdown: [
          { name: '시설급여', amount: 5.5, description: '요양시설 입소 비용 지원', recipient: '시설 입소 어르신 25만명' },
          { name: '재가급여', amount: 5.8, description: '방문요양, 주간보호, 방문간호 등', recipient: '재가 서비스 이용 어르신 85만명' },
          { name: '장기요양 관리운영비', amount: 1.2, description: '등급 판정, 시설 관리감독 등 운영비', recipient: '국민건강보험공단' },
        ],
      },
    ],
  },
  ...
  'education': {
    ...
    percentage: 13.4,
    yoy_change: 5.2,
    description: '유치원부터 대학까지 공교육을 운영하고, 교원 인건비, 학교 시설, 장학금 등을 지원하는 예산입니다. 대부분이 시·도교육청으로 이전되는 지방교육재정교부금입니다.',
    why_it_matters: '교육 예산의 약 80%는 "지방교육재정교부금"으로, 내국세의 20.79%가 자동으로 교육에 배정됩니다. 학생 수는 줄어드는데 예산은 내국세에 연동되어 계속 늘어 "교육재정 역설"이 발생하고 있습니다.',
    who_benefits: '초·중·고 학생 530만명, 대학생 320만명, 교원 50만명, 학부모',
    historical_trend: '2016년 53조 → 2026년 97조로 83% 증가. 같은 기간 학생 수는 640만 → 530만으로 17% 감소했습니다. 학생 1인당 교육비는 세계 최고 수준입니다.',
    controversy: '학생 수는 급감하는데 교부금은 내국세 연동으로 자동 증가하여 "돈은 넘치는데 학생은 없는" 상황입니다. 교부금 산정 방식 개편이 핵심 논쟁입니다.',
    related_ministry: '교육부, 17개 시·도교육청',
    sub_items: [
      {
        id: 'local-education-grant',
        name: '지방교육재정교부금',
        amount: 75.8,
        percentage: 78.0,
        description: '내국세 수입의 20.79%를 시·도교육청에 자동 배분하는 금액입니다. 교원 인건비, 학교 운영비 등 공교육의 핵심 재원입니다.',
        who_receives: '17개 시·도교육청 → 초·중·고 1만 2천여 학교',
        how_it_works: '국세(소득세, 법인세 등)의 20.79%가 법에 따라 자동으로 교육부를 거쳐 각 시·도교육청에 배분됩니다. 교육청은 이 돈으로 교사 월급, 학교 시설 관리, 급식 등을 운영합니다.',
        citizen_impact: '자녀가 학교에서 무상 의무교육을 받을 수 있는 기반입니다. 최근에는 무상급식(초·중), 무상교복, 수학여행 지원 등이 확대되었습니다.',
        real_example: '전남 순천시 한 초등학교는 전교생 87명이지만, 교부금 덕분에 교사 12명, 방과후 프로그램, 무상급식을 유지하고 있습니다. 인근 도시 학교와 같은 수준의 교육을 받을 수 있습니다.',
        trend: '내국세 증가에 연동되어 2019년 51조 → 2026년 76조로 꾸준히 증가. 학생 수 감소에도 불구하고 줄지 않아 1인당 단가는 오히려 증가.',
        issues: '학생 수는 줄어드는데 예산은 느는 "교육재정 역설"이 핵심입니다. 학교 통폐합 대신 남는 돈을 어떻게 쓸지, 교부금 비율을 낮춰 다른 복지에 쓸지가 쟁점입니다.',
        related_laws: ['지방교육재정교부금법'],
        breakdown: [
          { name: '교원 인건비', amount: 42.0, description: '초·중·고 교원 50만명의 급여·수당', recipient: '교원 50만명' },
          { name: '학교 운영비', amount: 18.5, description: '학교 시설 관리, 교재, 급식 등 운영 경비', recipient: '초·중·고 1만 2천 학교' },
          { name: '교육 사업비', amount: 15.3, description: '방과후학교, 돌봄교실, 교육격차 해소 사업 등', recipient: '학생 530만명' },
        ],
      },
      {
        ...
        amount: 12.5,
        percentage: 12.9,
        description: '국립대학 운영비, 사립대학 재정 지원, 대학 연구 지원 등 대학 교육의 질을 높이기 위한 예산입니다.',
        who_receives: '국립대학 40여 곳, 사립대학 150여 곳, 대학생 320만명',
        how_it_works: '국립대학은 운영비를 직접 지원받고, 사립대학은 평가를 통해 재정 지원 사업에 선정됩니다. 대표적으로 RISE(지역혁신 중심 대학지원체계) 사업이 있습니다.',
        citizen_impact: '대학 등록금이 2012년 이후 동결 수준인데, 이는 정부 지원으로 가능한 것입니다. 국립대 평균 등록금은 연 420만원, 사립대는 750만원 수준입니다.',
        real_example: '충남대학교(국립)는 정부 지원으로 등록금을 12년째 동결하면서도 AI 학과를 신설하고 실험실을 현대화했습니다. 학생들은 연 400만원대 등록금으로 수도권 사립대 수준의 교육을 받습니다.',
        trend: '학령인구 감소로 2025년부터 대학 정원이 입학 지원자를 초과하는 "역전 현상"이 시작됐습니다. 대학 구조조정이 불가피합니다.',
        issues: '지방대학 소멸 위기: 수도권 쏠림으로 지방대학이 정원을 채우지 못하고 있습니다. 정부는 RISE 사업으로 지방대를 지원하지만, 근본적 해결은 어렵다는 시각이 많습니다.',
        related_laws: ['고등교육법', '국립대학법인법'],
        breakdown: [
          { name: '국립대학 운영비', amount: 5.2, description: '국립대학 교직원 인건비 및 시설 운영', recipient: '국립대학 40여 곳' },
          { name: 'RISE·대학혁신 사업', amount: 4.5, description: '지역혁신 중심 대학 지원, 대학 특성화', recipient: '선정 대학 100여 곳' },
          { name: '대학 연구 지원', amount: 2.8, description: '학술연구교수, 기초연구, BK21 사업 등', recipient: '대학 연구진' },
        ],
      },
      {
        id: 'scholarship',
        ...
        amount: 4.8,
        percentage: 4.9,
        description: '소득 수준에 따라 대학 등록금을 지원하는 제도입니다. 소득 하위 80%까지 지원하며, 최대 전액(연 700만원)을 지원합니다.',
        who_receives: '대학생 약 150만명 (전체 대학생의 약 47%)',
        how_it_works: '한국장학재단 홈페이지에서 신청하면 가구 소득 구간(1~9구간)을 산정합니다. 1~3구간은 등록금 전액, 4~6구간은 일부 지원, 7~8구간은 소액 지원을 받습니다.',
        citizen_impact: '저소득층 학생이 경제적 이유로 대학을 포기하지 않도록 돕습니다. 도입(2012년) 이후 등록금 부담이 크게 줄었다는 평가입니다.',
        real_example: '전북 익산의 정수민 씨(20세)는 소득 2구간으로 국가장학금 520만원을 받아 국립대 등록금 400만원을 전액 충당하고, 나머지로 교재비를 삽니다. 아르바이트 시간을 줄이고 공부에 집중할 수 있게 됐습니다.',
        trend: '2012년 도입 이후 수혜자가 꾸준히 증가. 2026년에는 지원 단가 인상과 다자녀 가구 지원 확대가 예정되어 있습니다.',
        issues: '소득 구간 산정의 공정성 문제: 부모 소득은 적지만 재산이 많은 경우, 또는 자영업자 소득 파악의 어려움이 있습니다.',
        related_laws: ['한국장학재단 설립 등에 관한 법률'],
        breakdown: [
          { name: '소득연계 장학금(I유형)', amount: 3.5, description: '소득 구간별 등록금 직접 지원', recipient: '대학생 120만명' },
          { name: '국가근로장학금', amount: 0.7, description: '교내·교외 근로 활동 참여 학생에게 급여 지급', recipient: '근로장학생 10만명' },
          { name: '다자녀·기초생활 장학금', amount: 0.6, description: '다자녀 가구 및 기초생활수급자 자녀 추가 지원', recipient: '해당 대학생 20만명' },
        ],
      },
      {
        ...
        amount: 2.8,
        percentage: 2.9,
        description: '학교에 디지털 인프라를 구축하고, AI 활용 교육과정을 도입하며, 교원의 디지털 역량을 강화하는 예산입니다.',
        who_receives: '초·중·고 학생 530만명, 교원 50만명',
        how_it_works: '학교별 무선 인터넷 구축, 학생 1인 1태블릿 보급, AI 보조교사 시스템 도입, 디지털 교과서 개발 등을 추진합니다.',
        citizen_impact: '2025년부터 AI 디지털 교과서가 순차 도입되어, 학생 수준에 맞춘 맞춤형 학습이 가능해집니다. 학원비 절감 효과도 기대됩니다.',
        real_example: '세종시 한솔초등학교는 AI 보조교사 시스템을 시범 운영 중입니다. 수학 시간에 학생별 취약점을 AI가 분석해 개인 맞춤 문제를 제공하고, 교사는 도움이 필요한 학생에게 집중합니다.',
        trend: '코로나 이후 급성장한 에듀테크 분야에 정부가 본격 투자하기 시작. 2024년 1.5조 → 2026년 2.8조로 급증.',
        issues: '디지털 격차 우려: 스마트기기 활용에 익숙하지 않은 교원과 학생이 적응하지 못할 수 있습니다. AI 의존도가 높아지면 기본적인 사고력이 저하된다는 우려도 있습니다.',
        related_laws: ['교육기본법', '초·중등교육법'],
      },
      {
        id: 'school-meals',
        name: '학교 급식·돌봄',
        amount: 1.3,
        percentage: 1.3,
        description: '초·중학교 무상급식과 초등 돌봄교실 운영을 지원하는 예산입니다. (지방교육재정교부금과 별도)',
        who_receives: '초·중학교 학생 360만명(무상급식), 초등 돌봄교실 이용 아동 35만명',
        how_it_works: '초·중학교는 전면 무상급식을 실시하며, 급식비는 교육청과 지자체가 분담합니다. 초등 돌봄교실은 방과후 오후 5시까지(연장 시 7시) 학교에서 아이를 돌봐줍니다.',
        citizen_impact: '맞벌이 부부에게 초등 돌봄교실은 필수입니다. 학원비 없이도 방과후 안전하게 아이를 맡길 수 있습니다. 무상급식으로 가정의 식비 부담도 줄었습니다.',
        real_example: '광주 서구의 한 초등학교 돌봄교실에서는 방과후 간식, 독서, 레크리에이션 프로그램을 운영합니다. 맞벌이 가정의 이지은 씨(37세)는 "오후 6시에 퇴근해서 아이를 데리러 갈 수 있어 감사하다"고 합니다.',
        trend: '돌봄 수요가 증가하면서 2025년부터 "늘봄학교"가 전면 도입되어 희망하는 모든 초등학생에게 방과후 프로그램을 제공합니다.',
        issues: '돌봄 교사의 처우와 전문성, 학교 공간 부족 문제가 과제입니다. 교사들은 "수업 이외 돌봄까지 떠맡긴다"며 반발하고 있습니다.',
        related_laws: ['학교급식법', '초·중등교육법'],
      },
    ],
  },
  ...
  'defense': {
    ...
    percentage: 8.6,
    yoy_change: 4.8,
    description: '군 인력 운영, 무기 구매, 방위산업 육성, 장병 복지 등 국가 안보를 위한 예산입니다. 북한 핵 위협과 동북아 안보 환경에 대응합니다.',
    why_it_matters: '한반도는 세계에서 유일한 분단 국가입니다. 북한의 핵·미사일 위협, 미·중 전략 경쟁 속에서 적정 수준의 국방력 유지가 필수입니다. 동시에 병사 처우 개선, 첨단 무기 도입 등 군 현대화도 과제입니다.',
    who_benefits: '현역 군인 50만명, 예비군 310만명, 방위산업 종사자 10만명, 전체 국민(안보)',
    historical_trend: '2016년 39조 → 2026년 63조로 62% 증가. GDP 대비 국방비 비율은 2.5~2.7% 수준을 유지하고 있습니다.',
    controversy: '국방비 증가율을 높여 군 현대화를 가속해야 한다는 입장과, 외교·대화를 통한 안보가 더 효율적이라는 입장이 대립합니다.',
    related_ministry: '국방부, 방위사업청',
    sub_items: [
      {
        ...
        amount: 20.8,
        percentage: 33.3,
        description: '군인 인건비(장교·부사관·병사 급여), 피복비, 급식비 등 병력을 유지하는 데 드는 비용입니다.',
        who_receives: '현역 군인 약 50만명 (장교 7만, 부사관 13만, 병사 30만)',
        how_it_works: '장교·부사관은 일반 공무원과 유사한 월급 체계입니다. 병사 월급은 2026년 기준 약 150만원으로, 2017년(21만원) 대비 7배 이상 올랐습니다.',
        citizen_impact: '의무복무 중인 병사 월급 인상은 청년과 그 가정에 직접적 영향을 줍니다. 과거 "한 달에 커피값도 안 되는" 월급에서 이제는 최소한의 경제적 자립이 가능한 수준이 되었습니다.',
        real_example: '육군 이병 박준호(22세)는 월급 150만원 중 50만원을 적금에 넣고, 30만원으로 PX·식비를 충당하고, 나머지는 전역 후 학비로 모으고 있습니다. 2020년에 입대한 선배는 40만원밖에 못 받았다고 합니다.',
        trend: '병사 월급이 2017년 21만원 → 2023년 100만원 → 2026년 150만원으로 급등. 인구 감소로 병력은 줄이면서(상비병력 50만 목표) 처우는 높이는 추세입니다.',
        issues: '병사 월급 인상 속도가 너무 빠르다는 의견과, 여전히 민간 최저임금의 60%에 불과하다는 반론이 있습니다. 모병제 전환 논의도 꾸준히 제기됩니다.',
        related_laws: ['군인사법', '병역법'],
        breakdown: [
          { name: '장교·부사관 인건비', amount: 14.5, description: '직업군인 20만명의 급여·수당·퇴직금', recipient: '장교·부사관 20만명' },
          { name: '병사 급여', amount: 4.8, description: '의무복무 병사 월급 및 수당', recipient: '병사 30만명' },
          { name: '급식·피복·의료', amount: 1.5, description: '군인 식사, 군복, 군 병원 운영', recipient: '전체 군인 50만명' },
        ],
      },
      {
        id: 'weapons-acquisition',
        name: '방위력 개선(무기 도입)',
        amount: 22.5,
        percentage: 36.0,
        description: '전투기, 함정, 미사일 방어체계 등 첨단 무기를 연구·개발하거나 구매하는 예산입니다. 방위사업청이 집행합니다.',
        who_receives: '국내 방위산업 업체(한화에어로스페이스, LIG넥스원, 한국항공우주 등), 해외 무기 업체(록히드마틴, 레이시온 등)',
        how_it_works: '방위사업청이 합참의 소요(필요 무기)를 받아 획득 방법(국내 개발 vs 해외 구매)을 결정합니다. 국내 개발은 ADD(국방과학연구소)와 민간 업체가 공동 수행합니다.',
        citizen_impact: '직접 느끼기 어렵지만, 방위력 개선은 전쟁 억지력의 핵심입니다. 동시에 방위산업은 고부가가치 수출산업(2025년 수출 200억 달러)으로 성장하여 경제에도 기여합니다.',
        real_example: '한국형 전투기 KF-21 보라매는 총사업비 18조원을 투입해 개발 중이며, 2028년 실전 배치 예정입니다. 국내 기술로 만든 4.5세대 전투기로, 인도네시아에 수출도 추진 중입니다.',
        trend: '북한 핵·미사일 위협 고조로 2019년 15조 → 2026년 23조로 53% 증가. 킬체인, KAMD(한국형 미사일방어), KMPR(대량응징보복) 등 "3축 체계" 구축이 핵심입니다.',
        issues: '해외 무기 구매 시 "오프셋(절충교역)" 이행률이 낮아 비판받고 있습니다. 또한 방산 비리(업체-군 유착) 문제가 주기적으로 발생합니다.',
        related_laws: ['방위사업법', '방위산업기술보호법'],
        breakdown: [
          { name: '항공 전력(전투기 등)', amount: 8.5, description: 'KF-21 개발, F-35A 도입, 무인기 등', recipient: '한국항공우주, 록히드마틴 등' },
          { name: '해상 전력(함정 등)', amount: 5.2, description: '이지스함, 잠수함, 호위함 건조', recipient: 'HD현대, 한화오션 등' },
          { name: '미사일·방공 체계', amount: 5.8, description: '천궁-II, 현무 미사일, L-SAM 등', recipient: 'LIG넥스원, ADD 등' },
          { name: '지상 전력·C4I', amount: 3.0, description: '장갑차, 자주포, 지휘통제체계 현대화', recipient: '한화에어로스페이스, 현대로템 등' },
        ],
      },
      {
        ...
        amount: 14.2,
        percentage: 22.7,
        description: '기존 무기·장비의 정비, 탄약 구매, 유류비, 부대 시설 유지 등 군 전투력을 유지하는 데 드는 비용입니다.',
        who_receives: '군 부대 약 1,600개, 방산·정비 업체',
        how_it_works: '각 군(육·해·공·해병대)이 필요한 정비·보수·소모품을 요청하면, 국방부가 예산을 배분합니다. 항공기 엔진 오버홀, 함정 정비, 탄약 비축 등이 포함됩니다.',
        citizen_impact: '전쟁이 일어나면 이 예산이 부족할 경우 무기가 작동하지 않을 수 있습니다. "무기를 사는 것"보다 "가진 무기를 유지하는 것"이 더 중요하다는 전문가 의견이 많습니다.',
        real_example: 'F-35A 스텔스 전투기 1대의 연간 유지비는 약 50억원입니다. 엔진 정비, 스텔스 코팅 보수, 소프트웨어 업데이트 등이 필요합니다. 40대를 운영하면 유지비만 연 2,000억원이 듭니다.',
        trend: '첨단 무기 도입이 늘면서 유지비도 동반 상승. 특히 F-35, 이지스함 등 고가 무기의 유지비 부담이 커지고 있습니다.',
        issues: '유지비 부족으로 훈련시간이 줄어든다는 군 내부 불만이 있습니다. 무기 도입에만 집중하고 유지비를 과소 책정한다는 비판입니다.',
        related_laws: ['국방개혁법'],
        breakdown: [
          { name: '장비 정비·유지', amount: 6.5, description: '항공기, 함정, 차량 등 장비 정비', recipient: '군 정비부대, 방산 업체' },
          { name: '탄약 구매·관리', amount: 3.2, description: '훈련용·실전용 탄약 구매 및 저장 관리', recipient: '탄약 제조업체' },
          { name: '유류·시설 운영', amount: 4.5, description: '군용 유류 구매, 부대 시설 유지보수', recipient: '에너지 기업, 건설업체' },
        ],
      },
      {
        id: 'usfk-support',
        ...
        amount: 1.8,
        percentage: 2.9,
        description: '주한미군 주둔 경비의 일부를 한국이 부담하는 금액입니다. 한미 방위비분담특별협정(SMA)에 따라 매년 협상으로 결정됩니다.',
        who_receives: '주한미군 사령부 → 한국인 고용원 인건비, 미군기지 건설, 군수지원 등에 사용',
        how_it_works: '한미 간 5년 단위 협정을 체결하여 분담금 규모를 정합니다. 한국인 고용원(카투사 제외 한국인 근무자) 인건비, 미군 기지 건설·이전 비용, 군수 지원 비용으로 나뉩니다.',
        citizen_impact: '직접 체감하기 어렵지만, 주한미군 2만 8천명의 주둔은 북한 도발 억제의 핵심입니다. 방위비분담금 협상은 매번 한미 관계의 민감한 이슈가 됩니다.',
        real_example: '평택 캠프 험프리스(주한미군 사령부)에서 일하는 한국인 고용원은 약 1만 2천명입니다. 이들의 인건비 약 8,000억원이 한국 정부 분담금에서 나옵니다.',
        trend: '2019년 1.0조 → 2026년 1.8조로 80% 증가. 트럼프 1기 때 "5배 인상" 요구로 갈등이 있었고, 이후 안정적 인상으로 합의.',
        issues: '한국이 지나치게 많이 부담한다는 시각과, 미군 주둔 비용 대비 저렴하다는 시각이 대립합니다. GDP 대비 비율로는 NATO 동맹국보다 높은 수준입니다.',
        related_laws: ['한미 방위비분담특별협정'],
      },
      {
        id: 'military-welfare',
        name: '장병 복지·보훈',
        amount: 3.2,
        percentage: 5.1,
        description: '군인 복지(군 숙소 개선, 병영생활관 현대화), 군인 자녀 교육지원, 제대군인 취업 지원, 국가유공자 보훈 등의 예산입니다.',
        who_receives: '현역 군인 50만명, 제대군인 연 20만명, 국가유공자 85만명과 유족',
        how_it_works: '병영생활관 개선(4인실 → 2인실), 군 내 Wi-Fi·휴대폰 사용 허용, 제대군인 취업 박람회, 국가유공자 보상금 등으로 집행됩니다.',
        citizen_impact: '군 복무 환경이 크게 개선되면서 "군대가 사람 잡는 곳"이라는 인식이 바뀌고 있습니다. 자녀를 군에 보내는 부모의 걱정이 줄었습니다.',
        real_example: '2023년부터 병사들의 일과 후 휴대폰 사용이 허용되면서, 부모와 매일 영상통화를 할 수 있게 되었습니다. 병영생활관도 4인실로 개선되어 개인 공간이 확보되고 있습니다.',
        trend: 'MZ세대 병사의 눈높이에 맞춰 복지 예산이 매년 10% 이상 증가하고 있습니다.',
        issues: '보훈 대상 확대로 예산이 빠르게 증가하고 있습니다. 참전용사와 그 후손까지 보훈 혜택이 확대되면서 형평성 논란이 있습니다.',
        related_laws: ['군인복지기본법', '국가유공자 등 예우 및 지원에 관한 법률'],
      },
    ],
  },
  ...
  'local-admin': {
    ...
    percentage: 12.7,
    yoy_change: 3.8,
    description: '지방자치단체 교부세, 정부 청사 관리, 공무원 인건비, 통계·조달 등 정부 운영의 기반이 되는 예산입니다. 대부분이 지방교부세(지자체 재정 지원)입니다.',
    why_it_matters: '지방교부세는 내국세의 19.24%가 자동 배분되어 지자체의 기본 살림을 유지합니다. 서울 같은 부유한 지자체와 농촌 지자체의 재정 격차를 줄이는 역할을 합니다.',
    who_benefits: '243개 지방자치단체, 지방공무원 35만명, 전체 국민(행정 서비스)',
    historical_trend: '2016년 54조 → 2026년 93조로 72% 증가. 내국세 연동으로 자동 증가하나, 세수 감소 시 지자체 재정이 직접 타격을 받습니다.',
    controversy: '수도권-지방 간 재정 격차가 심화되고 있습니다. 일부 군·면 지역은 자체 수입이 10% 미만이어서 중앙정부 교부세 없이는 운영 불가능합니다.',
    related_ministry: '행정안전부, 인사혁신처',
    sub_items: [
      {
        id: 'local-subsidy',
        name: '지방교부세',
        amount: 68.5,
        percentage: 74.1,
        description: '내국세의 19.24%를 지자체에 배분하는 금액입니다. 지자체 간 재정 격차를 줄이고 기본적인 행정 서비스를 유지하게 합니다.',
        who_receives: '243개 지방자치단체 (서울특별시 제외 — 자체 세수로 충당)',
        how_it_works: '행정안전부가 각 지자체의 세입(수입)과 세출(지출) 차이를 계산하여 부족분을 교부합니다. 재정력이 약한 지자체에 더 많이 배분됩니다.',
        citizen_impact: '여러분이 사는 시·군·구에서 쓰레기 수거, 도로 보수, 주민센터 운영 등 기본 서비스가 가능한 이유입니다. 교부세가 줄면 동네 가로등 교체나 공원 관리가 늦어질 수 있습니다.',
        real_example: '전남 신안군은 자체 세수가 전체 예산의 8%에 불과합니다. 지방교부세로 공무원 월급, 도로 관리, 복지 서비스를 제공합니다. 교부세가 없으면 군청 문을 닫아야 합니다.',
        trend: '내국세 연동으로 자동 증가하지만, 2023~2024년 세수 결손(법인세·양도소득세 감소)으로 교부세가 예상보다 줄어 지자체들이 어려움을 겪었습니다.',
        issues: '교부세 배분 기준이 합리적인지 논쟁이 있습니다. 인구가 적은 농촌에 너무 많이 가고 대도시에 부족하다는 시각과, 농촌이야말로 더 지원이 필요하다는 반론이 있습니다.',
        related_laws: ['지방교부세법'],
        breakdown: [
          { name: '보통교부세', amount: 62.5, description: '지자체 재정 부족분 보전 — 인건비, 기본 운영비', recipient: '243개 지자체' },
          { name: '특별교부세', amount: 4.5, description: '재해 복구, 특수 수요 등 긴급 지원', recipient: '해당 지자체' },
          { name: '부동산교부세', amount: 1.5, description: '종합부동산세 수입을 지자체에 배분', recipient: '243개 지자체' },
        ],
      },
      {
        id: 'gov-operations',
        ...
        amount: 12.8,
        percentage: 13.8,
        description: '중앙부처 공무원 인건비, 정부청사 관리, 국정감사 운영, 외교·통상 활동 등 정부 기본 운영에 필요한 예산입니다.',
        who_receives: '중앙부처 공무원 약 20만명, 정부청사 관리업체',
        how_it_works: '각 부처별로 인건비(정원 기준), 기본경비(사무용품, 출장비, 통신비), 청사 관리비 등이 배정됩니다.',
        citizen_impact: '직접 느끼기 어렵지만, 정부 서비스(민원 처리, 정책 수립, 법 집행)의 기반입니다. 효율적인 운영이 곧 세금 절약입니다.',
        real_example: '정부24 온라인 민원 시스템은 연간 운영비 약 500억원이 들지만, 시민들이 주민등록등본·인감증명서 등을 집에서 발급받을 수 있게 해줍니다. 연간 5억 건의 민원을 처리합니다.',
        trend: '디지털 정부 전환으로 인력 효율화를 추진하고 있으나, 실제 공무원 수는 크게 줄지 않고 있습니다.',
        issues: '공무원 연금 적자가 연간 3조원에 달하며 세금으로 메우고 있습니다. 공무원 수 감축이나 급여 체계 개편이 필요하다는 의견이 있습니다.',
        related_laws: ['국가공무원법', '정부조직법'],
        breakdown: [
          { name: '중앙부처 인건비', amount: 8.5, description: '중앙부처 공무원 급여·수당·퇴직금', recipient: '중앙부처 공무원 20만명' },
          { name: '정부청사 관리', amount: 2.5, description: '세종·서울 청사 유지보수, 보안, 에너지', recipient: '조달청 관리 청사' },
          { name: '디지털 정부·전산', amount: 1.8, description: '정부24, 전자결재, 사이버보안 등', recipient: 'IT 기업' },
        ],
      },
      {
        id: 'local-balanced-dev',
        name: '균형발전 특별회계',
        amount: 11.2,
        percentage: 12.1,
        description: '수도권과 지방의 격차를 줄이기 위한 지역 개발 사업을 지원합니다. 지방 도시 재생, 낙후지역 개발, 지방 이전 기관 정착 지원 등이 포함됩니다.',
        who_receives: '비수도권 지자체, 혁신도시 이전 공공기관, 지역 주민',
        how_it_works: '지자체가 사업 계획을 제출하면 국가균형발전위원회가 심사하여 예산을 배정합니다. 포괄보조금 방식으로 지자체에 자율성을 부여합니다.',
        citizen_impact: '지방에 사는 국민도 수도권과 비슷한 수준의 교통·문화·의료 인프라를 누릴 수 있도록 돕습니다. 혁신도시 이전으로 지방에 양질의 일자리가 생기기도 했습니다.',
        real_example: '나주 혁신도시에는 한국전력, 한국농어촌공사 등 16개 기관이 이전했습니다. 인구가 2014년 1만명 → 2026년 5만명으로 5배 증가하고, 아파트·학교·병원이 들어섰습니다.',
        trend: '지방소멸 위기로 균형발전 예산이 꾸준히 증가하고 있으나, 수도권 집중은 오히려 심화되고 있습니다.',
        issues: '효과성 논란: 예산을 투입해도 청년들이 수도권으로 떠나는 현상을 막지 못하고 있습니다. 지방 소멸은 예산만으로 해결할 수 없다는 비판이 있습니다.',
        related_laws: ['국가균형발전특별법'],
        breakdown: [
          { name: '지역 자율 사업', amount: 6.5, description: '지자체가 자율적으로 기획한 지역 발전 사업', recipient: '비수도권 지자체' },
          { name: '혁신도시 지원', amount: 2.5, description: '공공기관 이전 지역 정착 지원', recipient: '10개 혁신도시' },
          { name: '낙후지역 개발', amount: 2.2, description: '접경지역, 성장촉진지역 등 특수 지역 지원', recipient: '70개 낙후지역' },
        ],
      },
    ],
  },
  ...
  'industry-energy': {
    ...
    percentage: 4.8,
    yoy_change: 8.2,
    description: '산업 경쟁력 강화, 중소기업·소상공인 지원, 에너지 전환, 무역·통상 등 경제 활력을 높이는 예산입니다.',
    why_it_matters: '한국 경제의 핵심인 반도체·배터리·자동차 등 주력 산업을 지원하고, 전체 기업의 99%를 차지하는 중소기업을 보호합니다. 에너지 전환(탈탄소)은 미래 경쟁력의 핵심입니다.',
    who_benefits: '중소기업 760만 곳, 소상공인 400만명, 에너지 산업 종사자, 수출기업',
    historical_trend: '2016년 18조 → 2026년 35조로 94% 증가. 반도체·AI 등 첨단산업 지원이 급증하고, 에너지 전환 투자가 본격화되었습니다.',
    controversy: '정부의 산업 지원이 "승자 선택(특정 기업 지원)"이 될 수 있다는 우려와, "글로벌 경쟁에서 살아남으려면 과감한 지원이 필수"라는 입장이 대립합니다.',
    related_ministry: '산업통상자원부, 중소벤처기업부',
    sub_items: [
      {
        id: 'sme-support',
        name: '중소기업·소상공인 지원',
        amount: 14.5,
        percentage: 41.7,
        description: '중소기업 정책자금 대출, 기술개발 지원, 소상공인 경영안정자금, 전통시장 현대화 등을 지원합니다.',
        who_receives: '중소기업 760만 곳, 소상공인 400만명',
        how_it_works: '중소벤처기업부가 정책자금(저리 대출)을 운영하고, 기술보증기금·신용보증기금이 보증을 제공합니다. 소상공인시장진흥공단이 전통시장 현대화, 컨설팅 등을 지원합니다.',
        citizen_impact: '동네 식당, 미용실, 편의점 등 소상공인이 저리 대출을 받아 사업을 유지할 수 있습니다. 전통시장 현대화(지붕 설치, 주차장, 카드결제 등)는 소비자에게도 편리합니다.',
        real_example: '대전 은행동 전통시장은 정부 지원으로 아케이드(지붕) 설치, 공영 주차장 건설, 모바일 결제 시스템을 도입했습니다. 일 매출이 30% 증가하고, 젊은 고객이 늘었습니다.',
        trend: '코로나 이후 소상공인 지원이 급증(2019년 6조 → 2021년 20조)했다가, 이후 정상화 과정에서 14.5조 수준으로 조정되었습니다.',
        issues: '정책자금 부실 대출 문제: 코로나 때 급히 풀린 자금의 상환이 시작되면서 소상공인 폐업이 증가하고 있습니다. "좀비 기업"을 연명시킨다는 비판이 있습니다.',
        related_laws: ['중소기업기본법', '소상공인 보호 및 지원에 관한 법률'],
        breakdown: [
          { name: '정책자금 대출', amount: 7.5, description: '중소기업·소상공인에 저리 대출 지원', recipient: '중소기업 10만 곳' },
          { name: '기술개발 지원', amount: 3.5, description: '중소기업 R&D, 기술 사업화 지원', recipient: '기술혁신 중소기업 5천 곳' },
          { name: '전통시장·소상공인 지원', amount: 3.5, description: '시장 현대화, 경영 컨설팅, 온라인 전환 지원', recipient: '전통시장 1,500곳, 소상공인 400만명' },
        ],
      },
      {
        ...
        amount: 8.5,
        percentage: 24.4,
        description: '태양광·풍력 등 재생에너지 보급, 수소경제 육성, 에너지 효율화, 탈탄소 산업 전환 등을 지원합니다.',
        who_receives: '재생에너지 발전사업자, 전기차·수소차 구매자, 에너지 효율화 참여 기업',
        how_it_works: '재생에너지 발전사업자에게 REC(신재생에너지 공급인증서)를 발급하여 수익을 보장합니다. 전기차·수소차 구매 시 보조금을 지급하고, 충전 인프라를 구축합니다.',
        citizen_impact: '전기차 보조금(2026년 최대 680만원)으로 전기차 구매 부담이 줄어듭니다. 태양광 보급으로 전기요금 안정에도 기여하지만, 동시에 재생에너지 부담금이 전기요금에 포함됩니다.',
        real_example: '전남 해남의 한 농민은 논 위에 태양광 패널(영농형 태양광)을 설치해 농사와 발전을 병행합니다. 쌀 수입 외에 전기 판매로 연 2,000만원 추가 소득을 올립니다.',
        trend: '2030 NDC(국가 온실가스 감축 목표)를 위해 재생에너지 비중을 30%까지 높이는 것이 목표. 투자가 매년 20% 이상 증가하고 있습니다.',
        issues: '재생에너지 입지 갈등: 태양광 산림 훼손, 풍력 소음 민원 등이 사회 문제가 되고 있습니다. 전기요금 현실화(인상) 없이는 에너지 전환이 어렵다는 지적도 있습니다.',
        related_laws: ['신에너지 및 재생에너지 개발·이용·보급 촉진법', '탄소중립기본법'],
        breakdown: [
          { name: '재생에너지 보급', amount: 3.8, description: '태양광·풍력 보급, REC 지원, 계통 연결', recipient: '재생에너지 사업자 10만 곳' },
          { name: '전기차·수소차 보급', amount: 2.5, description: '차량 구매 보조금, 충전 인프라 구축', recipient: '전기차 구매자 30만명' },
          { name: '수소경제 육성', amount: 1.2, description: '수소 생산·저장·운송 인프라, 수소연료전지', recipient: '수소 산업 기업' },
          { name: '에너지 효율화', amount: 1.0, description: '건물 에너지 진단, 고효율 설비 전환 지원', recipient: '기업·가정' },
        ],
      },
      {
        ...
        amount: 7.8,
        percentage: 22.4,
        description: '반도체, 배터리, 바이오, AI 등 국가 전략기술 분야를 집중 육성하는 예산입니다. 기업 투자에 대한 세제 혜택, 인력 양성, 인프라 구축을 지원합니다.',
        who_receives: '삼성전자·SK하이닉스 등 반도체 기업, 배터리 3사(LG·삼성·SK), AI 스타트업, 관련 중소 협력업체',
        how_it_works: '국가전략기술 지정 → 투자 세액공제(최대 25%) → 국비 R&D 지원 → 인력양성 프로그램 운영의 체계입니다. 반도체 메가 클러스터(용인) 등 대규모 인프라도 지원합니다.',
        citizen_impact: '반도체·배터리 등은 한국 수출의 30%를 차지합니다. 이 산업이 흔들리면 일자리와 경제 전체가 영향을 받습니다. 동시에 관련 분야의 고연봉 일자리가 늘어나는 효과도 있습니다.',
        real_example: '용인 반도체 메가 클러스터에는 삼성전자가 300조원 이상을 투자하여 세계 최대 반도체 생산기지를 건설 중입니다. 주변 지역에 5만개 이상의 일자리가 생길 전망입니다.',
        trend: '미·중 기술 갈등으로 경제안보 중요성이 부각되면서 첨단산업 지원이 급증. 2023년 국가첨단전략산업법 시행으로 체계적 지원이 시작되었습니다.',
        issues: '대기업 중심 지원이라는 비판이 있습니다. 반면 "글로벌 기업과 경쟁하려면 규모가 필요하다"는 반론도 있습니다. 반도체 인력 부족(연 3천명)도 심각한 과제입니다.',
        related_laws: ['국가첨단전략산업법', '산업기술혁신촉진법'],
        breakdown: [
          { name: '반도체 육성', amount: 3.5, description: '반도체 R&D, 인력양성, 인프라 구축', recipient: '반도체 기업·대학' },
          { name: '배터리·미래차', amount: 2.0, description: '이차전지 R&D, 전기차 부품산업 육성', recipient: '배터리·자동차 기업' },
          { name: 'AI·디지털 산업', amount: 1.5, description: 'AI 반도체, 클라우드, SW 산업 지원', recipient: 'AI 기업·스타트업' },
          { name: '바이오·우주 등 신산업', amount: 0.8, description: '바이오의약품, 우주발사체, 로봇 산업', recipient: '신산업 기업' },
        ],
      },
      {
        id: 'trade-export',
        ...
        amount: 4.0,
        percentage: 11.5,
        description: '수출 중소기업 지원, KOTRA 해외 진출 지원, FTA 활용 지원, 수출보험 등 한국 기업의 해외 시장 개척을 돕는 예산입니다.',
        who_receives: '수출 중소기업 8만 곳, KOTRA(대한무역투자진흥공사), 한국무역보험공사',
        how_it_works: 'KOTRA가 127개국에 무역관을 운영하며 바이어 발굴, 전시회 참가, 시장 조사를 지원합니다. 한국무역보험공사가 수출 대금 미회수 리스크를 보증합니다.',
        citizen_impact: '한국은 GDP의 40%가 수출입니다. 수출이 줄면 일자리와 경제성장이 직접 타격을 받습니다. K-뷰티, K-푸드 등 소비재 수출이 늘면서 소비자도 해외에서 한국 제품을 쉽게 만날 수 있습니다.',
        real_example: '경기도의 한 화장품 중소기업은 KOTRA 지원으로 동남아 바이어를 만나 연 50억원 수출 계약을 체결했습니다. 직원을 30명에서 80명으로 늘렸습니다.',
        trend: '글로벌 공급망 재편으로 "프렌드쇼어링" 전략 지원이 늘고 있습니다. K-콘텐츠·K-뷰티 등 문화 수출 지원도 확대 중입니다.',
        related_laws: ['대외무역법', '무역보험법'],
      },
    ],
  },
  ...
  'rnd': {
    ...
    percentage: 4.3,
    yoy_change: 12.5,
    description: '국가 연구개발(R&D) 예산으로, 기초과학부터 응용기술까지 과학기술 혁신을 위한 투자입니다. 대학, 출연연구소, 기업 연구소에 배분됩니다.',
    why_it_matters: '한국의 GDP 대비 R&D 투자 비율은 4.9%로 세계 2위입니다. 이 중 정부 R&D가 약 25%를 차지합니다. 기초과학 투자는 미래 먹거리의 씨앗이며, 단기 성과를 내기 어렵지만 장기적으로 국가 경쟁력의 원천입니다.',
    who_benefits: '대학 연구진 10만명, 출연연구소(KAIST, KIST 등) 연구원 3만명, 기업 연구소, 이공계 대학원생',
    historical_trend: '2016년 19조 → 2024년 26조 → 2025년 22조(감축) → 2026년 32조(회복). 2025년 대규모 R&D 예산 삭감은 과학계의 큰 충격이었습니다.',
    controversy: '2025년 R&D 예산 16% 삭감(26조 → 22조)으로 기초과학·청년 연구자 지원이 급감하여 큰 논란이 되었습니다. 2026년에 대폭 회복(32조)했지만, 연구 현장의 신뢰 회복이 과제입니다.',
    related_ministry: '과학기술정보통신부, 산업통상자원부, 보건복지부',
    sub_items: [
      {
        id: 'basic-science',
        name: '기초과학 연구',
        amount: 8.5,
        percentage: 27.0,
        description: '당장 돈이 되지 않지만 미래를 위해 필수적인 기초과학 연구를 지원합니다. 물리학, 화학, 생명과학, 수학 등 근본적인 과학 지식을 탐구합니다.',
        who_receives: '대학 교수·연구원 약 5만명, 기초과학연구원(IBS), 한국연구재단 지원 연구자',
        how_it_works: '한국연구재단이 연구자의 과제 제안서를 심사하여 연구비를 배분합니다. 개인 연구(3~5년, 연 1~5억원)부터 대형 집단 연구(IBS 연구단, 연 100억원)까지 다양합니다.',
        citizen_impact: '직접 체감하기 어렵지만, mRNA 백신(코로나)은 30년 전 기초연구에서 시작되었습니다. 반도체, 스마트폰, GPS 모두 기초과학 연구의 결실입니다.',
        real_example: 'IBS(기초과학연구원)의 양자나노과학 연구단은 원자 수준에서 양자 현상을 관측하는 데 성공하여 네이처에 논문을 발표했습니다. 이 연구는 미래 양자컴퓨터의 기반이 될 수 있습니다.',
        trend: '2025년 예산 삭감으로 기초연구비가 30% 축소되어 진행 중인 연구가 중단되는 사태가 발생했습니다. 2026년 대폭 회복했지만 연구 연속성에 타격을 입었습니다.',
        issues: '단기 성과주의: 정부가 "성과가 보이는 연구"를 선호하면서 기초과학 투자가 불안정합니다. 과학자들은 "5~10년 장기 연구가 보장되어야 노벨상급 성과가 나온다"고 주장합니다.',
        related_laws: ['기초연구진흥 및 기술개발지원에 관한 법률'],
        breakdown: [
          { name: '개인 기초연구', amount: 3.5, description: '대학 교수의 자유 주제 연구 지원', recipient: '대학 연구자 3만명' },
          { name: 'IBS(기초과학연구원)', amount: 2.5, description: '세계 수준의 기초과학 집중 연구', recipient: 'IBS 연구단 30개' },
          { name: '집단 연구·리더 연구', amount: 2.5, description: '대형 연구센터, 선도 연구자 지원', recipient: '대학·연구소 100곳' },
        ],
      },
      {
        id: 'national-strategic-tech',
        name: '국가전략기술 R&D',
        amount: 10.2,
        percentage: 32.4,
        description: '반도체, AI, 양자, 바이오, 우주, 원자력 등 12대 국가전략기술 분야의 연구개발을 집중 지원합니다.',
        who_receives: '출연연구소(ETRI, KIST 등), 대학, 대기업·중소기업 연구소',
        how_it_works: '국가과학기술자문회의가 전략기술을 선정하고, 과기부·산업부 등이 대형 R&D 과제를 기획·공모합니다. 산학연 컨소시엄으로 수행하는 경우가 많습니다.',
        citizen_impact: '전략기술 R&D의 성과는 5~10년 후에 산업으로 이어집니다. 현재 세계를 선도하는 한국의 반도체·배터리·디스플레이 기술은 과거 R&D 투자의 결과입니다.',
        real_example: 'ETRI(전자통신연구원)가 개발한 5G 핵심 기술은 삼성·LG에 이전되어 한국이 세계 최초 5G 상용화(2019년)를 달성하는 데 기여했습니다. 정부 R&D 약 3,000억원이 투입되었습니다.',
        trend: '미·중 기술 패권 경쟁으로 전략기술 R&D가 급증. 2023년 7조 → 2026년 10조로 43% 증가했습니다.',
        issues: '출연연구소의 역할 재정립이 필요하다는 지적이 있습니다. 대기업이 스스로 할 수 있는 연구에 정부 R&D가 투입되는 "크라우딩 아웃" 문제도 제기됩니다.',
        related_laws: ['국가첨단전략산업법', '과학기술기본법'],
        breakdown: [
          { name: '반도체·디스플레이 R&D', amount: 3.5, description: '차세대 반도체 공정, 소재·장비 국산화', recipient: '반도체 관련 연구소·기업' },
          { name: 'AI·양자 R&D', amount: 2.8, description: 'AI 초거대 모델, 양자컴퓨팅, 데이터 사이언스', recipient: 'AI 연구소·스타트업' },
          { name: '바이오·의료 R&D', amount: 2.2, description: '신약 개발, 바이오시밀러, 디지털 헬스케어', recipient: '바이오 기업·병원·대학' },
          { name: '우주·원자력 R&D', amount: 1.7, description: '한국형 발사체 고도화, 소형모듈원전(SMR) 개발', recipient: '한국항공우주연구원, 원자력연구원' },
        ],
      },
      {
        ...
        amount: 4.8,
        percentage: 15.2,
        description: '이공계 대학원생 장학금, 박사후연구원(포스닥) 지원, 여성·청년 과학자 지원 등 과학기술 인재를 키우는 예산입니다.',
        who_receives: '이공계 대학원생 10만명, 포스닥 1만명, 신진 연구자',
        how_it_works: 'BK21(대학원 혁신 사업)으로 대학원생에게 월 120~150만원 연구 장려금을 지급합니다. 신진 연구자에게는 독립 연구비를 지원하여 자기 연구를 시작할 수 있도록 합니다.',
        citizen_impact: '석·박사 인력이 부족하면 첨단 기업(반도체, 바이오 등)이 인력을 구하지 못합니다. 연구인력 양성은 곧 미래 산업의 기반입니다.',
        real_example: 'KAIST 박사과정 이수진 씨(29세)는 BK21 장학금 월 150만원과 연구 참여비 월 50만원을 받으며 AI 연구를 하고 있습니다. "미국 유학 대신 국내에서 연구할 수 있는 것은 이 지원 덕분"이라고 합니다.',
        trend: '이공계 기피 현상이 심화되면서 대학원생 처우 개선이 시급합니다. 공학 박사 배출이 줄어 반도체 인력 부족이 심각해지고 있습니다.',
        issues: '박사 학위 취득 후 안정적 연구직을 구하기 어려운 "포스닥 지옥" 문제가 있습니다. 3~5년 단기 계약을 반복하며 불안정한 고용에 시달리는 연구자가 많습니다.',
        related_laws: ['과학기술인력 육성·지원에 관한 법률'],
        breakdown: [
          { name: 'BK21(대학원 혁신)', amount: 2.5, description: '대학원생 연구 장려금 및 교육 프로그램', recipient: '이공계 대학원생 8만명' },
          { name: '신진·청년 연구자 지원', amount: 1.5, description: '포스닥 연구비, 신진 교수 초기 정착금', recipient: '포스닥·신진 연구자 1만명' },
          { name: '이공계 인력양성 사업', amount: 0.8, description: '반도체·AI 계약학과, 산학연계 교육', recipient: '대학·대학원생' },
        ],
      },
      {
        id: 'rnd-institutes',
        ...
        amount: 5.5,
        percentage: 17.5,
        description: 'KAIST, KIST, ETRI, 한국원자력연구원 등 25개 정부 출연 연구소의 기본 운영비와 연구비입니다.',
        who_receives: '25개 출연연구소 연구원 약 3만명',
        how_it_works: '각 출연연구소에 기관 운영비(인건비·시설비)와 기본 연구사업비를 배정합니다. 이 외에 경쟁 과제를 수주하여 추가 연구비를 확보합니다.',
        citizen_impact: '출연연구소는 기업이 하기 어려운 중장기 연구를 담당합니다. KIST가 개발한 초고속 인터넷 기술, ETRI의 반도체 설계 기술 등이 산업으로 이전되어 경제를 이끌고 있습니다.',
        real_example: 'KIST(한국과학기술연구원)는 설립 60년간 약 8,000건의 기술을 산업계에 이전했습니다. 최근에는 수소연료전지 핵심 소재를 개발하여 현대차에 기술을 이전했습니다.',
        trend: '기관 운영비는 정체되고 경쟁 과제 비중이 높아져, 연구원들이 과제 수주에 쫓기고 있다는 불만이 있습니다.',
        issues: '출연연구소의 역할이 대학·기업 연구소와 중복된다는 비판이 있습니다. 구조 개혁이 필요하다는 의견과, "공공 연구의 보루를 지켜야 한다"는 의견이 대립합니다.',
        related_laws: ['과학기술분야 정부출연연구기관 등의 설립·운영 및 육성에 관한 법률'],
      },
      {
        id: 'space-program',
        name: '우주개발',
        amount: 2.5,
        percentage: 7.9,
        description: '한국형 발사체(누리호) 고도화, 달 탐사, 위성 개발·발사, 우주 산업 육성 등의 예산입니다.',
        who_receives: '한국항공우주연구원(KARI), 우주 스타트업, 위성 제조업체',
        how_it_works: 'KARI가 발사체·위성 핵심 기술을 개발하고, 민간 기업에 기술을 이전하여 우주 산업 생태계를 키웁니다. 2032년 달 착륙 목표를 세우고 있습니다.',
        citizen_impact: '우주 기술은 GPS 내비게이션, 기상 예보, 재난 감시 등 일상생활과 직결됩니다. 독자 위성 발사 능력은 국가 안보에도 중요합니다.',
        real_example: '누리호(나로우주센터) 3차 발사 성공(2024년)으로 한국은 세계 7번째 독자 발사 능력을 확보했습니다. 탑재된 차세대소형위성 2호는 지구 관측 임무를 수행 중입니다.',
        trend: '2024년 1.2조 → 2026년 2.5조로 2배 이상 증가. 우주항공청 출범(2024년)과 함께 투자가 본격화되고 있습니다.',
        issues: '미국·유럽 대비 예산 규모가 1/30 수준으로, "우주 강국"을 표방하기엔 부족하다는 평가입니다. 민간 우주 산업 생태계가 아직 초기 단계입니다.',
        related_laws: ['우주항공청 설치법', '우주개발진흥법'],
      },
    ],
  },
  ...
  'public-safety': {
    ...
    percentage: 3.5,
    yoy_change: 5.5,
    description: '경찰, 소방, 해경, 검찰 등 국민의 안전과 사회 질서를 유지하는 예산입니다. 범죄 예방, 재난 대응, 교통 관리 등을 담당합니다.',
    why_it_matters: '일상의 안전은 삶의 기본 조건입니다. 112/119에 전화하면 출동하는 경찰·소방이 이 예산으로 운영됩니다. 이태원 참사(2022년) 이후 안전 투자의 중요성이 재인식되었습니다.',
    who_benefits: '전체 국민(치안·소방), 범죄 피해자, 재난 취약 지역 주민',
    historical_trend: '2016년 18조 → 2026년 26조로 44% 증가. 경찰·소방 인력 확충과 처우 개선이 주요 증가 요인입니다.',
    controversy: '경찰 권한 강화(수사권 이관) 이후 견제 장치가 약하다는 우려와, 소방관 부족으로 현장 대응이 늦어진다는 문제가 공존합니다.',
    related_ministry: '경찰청, 소방청, 해양경찰청, 법무부',
    sub_items: [
      {
        id: 'police',
        name: '경찰',
        amount: 13.8,
        percentage: 53.5,
        description: '13만 경찰관의 인건비, 치안 장비, 파출소 운영, 수사, 교통 관리, 사이버 수사 등 치안 활동 전체 예산입니다.',
        who_receives: '경찰관 약 13만명, 경찰청·시·도경찰청·경찰서·파출소 2,300곳',
        how_it_works: '경찰청이 예산을 편성하고, 각 시·도경찰청과 경찰서에 배분합니다. 112 신고 접수·출동, 순찰, 수사, 교통 관리 등 업무별로 예산이 배정됩니다.',
        citizen_impact: '112에 전화하면 평균 5분 내에 경찰이 출동합니다(도시 기준). 파출소 순찰, CCTV 관제, 범죄 예방 활동이 일상의 안전을 지킵니다.',
        real_example: '서울 강남경찰서는 관할 지역에 스마트 CCTV 500대를 설치하여 범죄 의심 행동을 AI가 자동 감지합니다. 도입 후 관내 5대 범죄가 15% 감소했습니다.',
        trend: '수사권 전환(검찰 → 경찰) 이후 수사 인력·예산이 증가하고 있습니다. 사이버 범죄·디지털 성범죄 대응 예산도 매년 20% 이상 증가합니다.',
        issues: '경찰 인력 부족: 인구 대비 경찰관 수가 OECD 평균의 60% 수준입니다. 특히 농촌 지역에서 112 출동에 30분 이상 걸리는 경우도 있습니다.',
        related_laws: ['경찰법', '형사소송법'],
        breakdown: [
          { name: '경찰관 인건비', amount: 10.2, description: '13만 경찰관의 급여·수당·퇴직금', recipient: '경찰관 13만명' },
          { name: '치안 장비·시설', amount: 2.0, description: '순찰차, CCTV, 무전기, 파출소 시설', recipient: '경찰서·파출소 2,300곳' },
          { name: '수사·사이버 대응', amount: 1.6, description: '수사 장비, 디지털 포렌식, 사이버수사대', recipient: '경찰 수사 부서' },
        ],
      },
      {
        id: 'fire-service',
        ...
        amount: 6.5,
        percentage: 25.2,
        description: '6만 소방관의 인건비, 소방차·구급차, 119 구급 서비스, 화재 진압, 구조 장비 등의 예산입니다.',
        who_receives: '소방관 약 6만명, 소방서·119안전센터 1,900곳',
        how_it_works: '소방청이 전국 소방서에 예산을 배분합니다. 화재 진압, 구조·구급, 예방 활동(건물 안전 점검)으로 나뉩니다. 119 신고 시 소방차·구급차가 출동합니다.',
        citizen_impact: '119에 전화하면 평균 7분 내에 구급차가 도착합니다. 심정지 환자의 경우 "골든 타임 4분" 내 도착이 생존율을 3배 높입니다. 소방관 1인당 담당 인구가 850명으로 선진국(500명)보다 과부하입니다.',
        real_example: '부산의 한 아파트에서 화재가 발생했을 때, 119 신고 3분 만에 소방차가 도착하여 20가구를 대피시키고 진화했습니다. 인명 피해 없이 해결할 수 있었던 것은 소방 장비 현대화 덕분입니다.',
        trend: '소방관이 국가직으로 전환(2020년)되면서 처우가 개선되고, 신규 채용이 늘고 있습니다. 2019년 5만명 → 2026년 6만명으로 증원.',
        issues: '소방관 PTSD(외상 후 스트레스)가 심각합니다. 참혹한 현장을 반복 경험하면서 정신건강 문제를 호소하는 소방관이 30%에 달합니다. 심리치료 예산이 부족합니다.',
        related_laws: ['소방기본법', '119구조·구급에 관한 법률'],
        breakdown: [
          { name: '소방관 인건비', amount: 4.2, description: '6만 소방관의 급여·수당·위험수당', recipient: '소방관 6만명' },
          { name: '소방 장비·차량', amount: 1.5, description: '소방차, 구급차, 사다리차, 구조 장비', recipient: '소방서 1,900곳' },
          { name: '119 구급 서비스', amount: 0.8, description: '구급차 운영, 응급의료 장비, 이송 시스템', recipient: '전국 구급대 1,600곳' },
        ],
      },
      {
        ...
        amount: 3.2,
        percentage: 12.4,
        description: '태풍·지진·홍수 등 자연재해와 대형 사고에 대비하고 복구하는 예산입니다. 행정안전부 재난안전관리본부가 총괄합니다.',
        who_receives: '전국 지자체(재난 대비·복구), 이재민, 재난 취약 시설',
        how_it_works: '평상시에는 재난 대비 훈련, 위험 시설 점검, 재난 문자 시스템 운영을 하고, 재난 발생 시 긴급 구호·복구 예산을 투입합니다. 예비비에서 추가 투입도 가능합니다.',
        citizen_impact: '재난 문자(긴급재난문자)를 통해 태풍, 폭우, 지진 등을 미리 대비할 수 있습니다. 이재민에게는 생활비, 주거비, 의료비를 지원합니다.',
        real_example: '2023년 오송 지하차도 침수 사고(16명 사망) 이후, 전국 지하차도 4,500곳에 자동 차단 시스템과 수위 센서가 설치되었습니다. 2026년까지 전체 설치 완료가 목표입니다.',
        trend: '기후변화로 이상 기상이 잦아지면서 재난 관리 예산이 꾸준히 증가. 특히 도시 침수 대응(지하 배수 시설 등) 투자가 확대되고 있습니다.',
        issues: '재난 발생 후 "사후약방문" 식 대응이라는 비판이 있습니다. 예방 투자보다 복구 비용이 더 크지만, 예방에는 예산이 적게 배정되는 구조입니다.',
        related_laws: ['재난 및 안전관리 기본법'],
        breakdown: [
          { name: '재난 예방·대비', amount: 1.5, description: '위험 시설 점검, 재난 훈련, 예경보 시스템', recipient: '전국 지자체' },
          { name: '재난 복구·지원', amount: 1.2, description: '재해 복구, 이재민 지원, 시설 복구', recipient: '이재민, 피해 지자체' },
          { name: '안전 인프라', amount: 0.5, description: '재난 문자 시스템, CCTV, 안전 센서 등', recipient: '전국 행정기관' },
        ],
      },
      {
        id: 'prosecution-courts',
        name: '검찰·법원',
        amount: 2.3,
        percentage: 8.9,
        description: '검찰의 공소유지·수사, 법원의 재판 운영, 법률구조 등 사법 시스템 운영 예산입니다.',
        who_receives: '검사 약 2,300명, 판사 약 3,000명, 법원·검찰 직원, 법률구조공단',
        how_it_works: '검찰은 기소·공소유지와 일부 수사(중대 범죄)를 담당합니다. 법원은 민·형사·행정 재판을 운영합니다. 경제적 약자에게는 법률구조공단이 무료 법률 서비스를 제공합니다.',
        citizen_impact: '법적 분쟁이 생겼을 때 공정한 재판을 받을 권리가 보장됩니다. 저소득층은 법률구조공단을 통해 무료 소송 대리를 받을 수 있습니다.',
        real_example: '수원의 한 임차인은 보증금 1억원을 돌려받지 못했을 때, 법률구조공단의 무료 소송 대리를 통해 전액 회수에 성공했습니다. 변호사 비용 300만원을 절약했습니다.',
        trend: '전자소송 도입으로 재판 효율이 높아지고 있으나, 민사 재판 평균 기간이 1년 이상이어서 "재판 지연" 문제가 여전합니다.',
        related_laws: ['법원조직법', '검찰청법'],
      },
    ],
  },
  ...
  'soc': {
    ...
    percentage: 3.9,
    yoy_change: 6.2,
    description: '도로, 철도, 항만, 공항, 수자원 등 사회기반시설(SOC)을 건설하고 유지하는 예산입니다. 교통 편의와 물류 효율을 높이고, 지역 균형 발전에 기여합니다.',
    why_it_matters: 'SOC 투자는 단기적으로 건설 일자리를 만들고, 장기적으로 물류비 절감·이동시간 단축 등 경제적 효과를 냅니다. 다만 "대형 토목 사업"에 대한 낭비 우려도 상존합니다.',
    who_benefits: '전체 국민(교통 이용), 건설업 종사자 180만명, 물류 산업, 지방 주민',
    historical_trend: '2016년 22조 → 2020년 21조(코로나 시기 감소) → 2026년 29조로 회복. SOC 예산은 경기 부양 vs 재정 긴축의 바로미터입니다.',
    controversy: '대형 SOC 사업(GTX, 신공항 등)의 타당성 논란이 반복됩니다. "필요한 투자"와 "선심성 토건 사업" 사이의 경계가 불분명합니다.',
    related_ministry: '국토교통부, 해양수산부',
    sub_items: [
      {
        id: 'roads',
        name: '도로',
        amount: 8.5,
        percentage: 29.8,
        description: '고속도로 건설·유지, 국도 확장·포장, 교량·터널 안전 점검 등 도로 인프라 전체 예산입니다.',
        who_receives: '한국도로공사, 건설업체, 지자체(국도 관리)',
        how_it_works: '국토부가 도로 건설 계획을 수립하고, 한국도로공사(고속도로)와 지자체(국도)가 집행합니다. 민자 사업(민간 투자 도로)도 포함됩니다.',
        citizen_impact: '출퇴근 시간 단축, 물류비 절감으로 택배비·식품 가격에도 영향을 줍니다. 2차선 국도를 4차선으로 확장하면 사고율이 40% 감소합니다.',
        real_example: '세종-포천 고속도로 완공(2024년)으로 수도권 동북부 → 세종 이동시간이 3시간 → 1시간 40분으로 단축되었습니다. 주변 지역 지가가 20% 상승했습니다.',
        trend: '신규 건설보다 기존 도로의 유지·보수·안전 강화에 예산 비중이 높아지고 있습니다. 노후 교량 점검·보강이 급선무입니다.',
        issues: '고속도로 민자사업의 수익 보장 논란: 교통량이 예상보다 적어도 정부가 최소 수익을 보장해야 하는 계약이 문제가 됩니다.',
        related_laws: ['도로법', '한국도로공사법'],
        breakdown: [
          { name: '고속도로 건설·유지', amount: 4.5, description: '고속도로 신규 건설 및 기존 도로 유지보수', recipient: '한국도로공사' },
          { name: '국도·지방도 정비', amount: 2.5, description: '국도 확장, 병목 해소, 보행자 안전 시설', recipient: '지자체·건설업체' },
          { name: '교량·터널 안전 관리', amount: 1.5, description: '노후 교량 보강, 터널 안전 설비 개선', recipient: '관리 기관' },
        ],
      },
      {
        id: 'railways',
        ...
        amount: 10.2,
        percentage: 35.8,
        description: 'KTX 노선 확장, GTX(수도권 광역급행), 일반 철도 개량, 도시 철도 건설 등 철도 인프라 예산입니다.',
        who_receives: '한국철도공사(코레일), 한국철도시설공단, 건설업체',
        how_it_works: '국토부가 철도 건설 계획을 수립하고 한국철도시설공단이 시공을 관리합니다. 완공된 철도는 코레일이 운영합니다. GTX 등 수도권 사업은 별도 특수목적법인이 운영합니다.',
        citizen_impact: 'KTX 동남권(진주-부산) 개통으로 서울-진주가 2시간대로 단축됩니다. GTX-A(파주-동탄) 개통으로 수도권 출퇴근 시간이 크게 줄어듭니다.',
        real_example: 'GTX-A 노선이 2024년 개통되어, 킨텍스(일산) → 서울역 이동 시간이 기존 지하철 50분에서 GTX 20분으로 단축되었습니다. 인근 아파트 가격이 15% 상승했습니다.',
        trend: 'GTX(A·B·C), KTX 연장, 월곶-판교선 등 대형 철도 사업이 동시 진행 중이어서 예산 수요가 급증하고 있습니다.',
        issues: '철도 사업은 공사 기간이 10~15년으로 길고, 비용 초과가 빈번합니다. GTX-B 노선은 당초 5조 → 현재 추정 15조로 3배 증가했습니다.',
        related_laws: ['철도산업발전기본법', '대도시권 광역교통 관리에 관한 특별법'],
        breakdown: [
          { name: 'GTX(광역급행철도)', amount: 4.0, description: 'GTX-A·B·C 노선 건설 및 운영 준비', recipient: '철도시설공단, GTX 사업법인' },
          { name: 'KTX 노선 확장', amount: 3.0, description: 'KTX 동남권·서해선·중부내륙선 등', recipient: '코레일, 철도시설공단' },
          { name: '일반철도·도시철도', amount: 3.2, description: '일반 철도 개량, 도시 지하철 건설', recipient: '지자체, 철도 공사' },
        ],
      },
      {
        id: 'ports-airports',
        ...
        amount: 4.5,
        percentage: 15.8,
        description: '부산항·인천항 등 항만 시설과 인천공항·김해공항 등 공항 시설의 건설·유지 예산입니다.',
        who_receives: '해양수산부, 인천국제공항공사, 항만공사, 건설업체',
        how_it_works: '해수부가 항만 건설 계획을, 국토부가 공항 건설 계획을 수립합니다. 항만 하역 시설, 방파제, 활주로, 터미널 건설 등이 포함됩니다.',
        citizen_impact: '한국 수출의 99%가 항만·공항을 통합니다. 물류 효율이 높아지면 수출 기업의 경쟁력이 올라가고, 소비자는 수입품을 더 싸게 살 수 있습니다. 공항 확충은 해외여행 편의성을 높입니다.',
        real_example: '인천공항 제2터미널 확장(탑승동 신설)으로 연간 수용 능력이 7,200만명 → 1억명으로 늘어났습니다. 출국 심사 대기 시간이 평균 15분에서 8분으로 줄었습니다.',
        trend: '수도권 제3공항(가덕도 신공항) 건설이 추진 중이며, 부산항 북항 재개발 등 대형 사업이 진행 중입니다.',
        issues: '가덕도 신공항은 사업비 28조원에 안전성·경제성 논란이 있습니다. 김해공항 확장으로 충분하다는 반대 의견이 있습니다.',
        related_laws: ['항만법', '공항시설법'],
        breakdown: [
          { name: '항만 건설·유지', amount: 2.8, description: '부산항·인천항 시설 확충, 항만 재개발', recipient: '항만공사, 해수부' },
          { name: '공항 건설·유지', amount: 1.7, description: '인천공항 확장, 가덕도 신공항, 지방 공항', recipient: '인천국제공항공사, 국토부' },
        ],
      },
      {
        id: 'water-resources',
        ...
        amount: 5.3,
        percentage: 18.6,
        description: '댐 건설·유지, 하천 정비, 상수도·하수도 인프라, 수해 방지 시설 등 물 관련 인프라 예산입니다.',
        who_receives: '한국수자원공사, 지자체(상하수도), 건설업체',
        how_it_works: '환경부와 한국수자원공사가 댐·보 관리, 상수도 공급을 담당합니다. 하천 정비와 수해 방지는 국토부와 지자체가 협력합니다.',
        citizen_impact: '수돗물을 마시고, 비가 많이 와도 하천이 범람하지 않도록 관리하는 것이 이 예산의 역할입니다. 노후 상수도관(30년 이상) 교체는 수돗물 품질에 직결됩니다.',
        real_example: '인천시는 노후 상수도관 교체 사업(총 1.2조원)으로 녹물 민원이 연 5,000건 → 500건으로 90% 감소했습니다. 40년 된 납 배관을 스테인리스 배관으로 교체하고 있습니다.',
        trend: '기후변화로 극한 강수가 증가하면서 수해 방지 투자가 늘고 있습니다. 노후 상수도관(전국 23%) 교체도 시급합니다.',
        issues: '4대강 보 처리 문제: 이명박 정부 시절 건설된 보의 철거 vs 유지 논쟁이 계속되고 있습니다. 철거 비용도 수조원이 소요됩니다.',
        related_laws: ['수자원의 조사·계획 및 관리에 관한 법률', '하천법'],
        breakdown: [
          { name: '하천 정비·수해 방지', amount: 2.5, description: '제방 보강, 배수 시설, 침수 방지', recipient: '지자체·수자원공사' },
          { name: '상수도·하수도 정비', amount: 1.8, description: '노후관 교체, 정수 시설 현대화', recipient: '지자체' },
          { name: '댐·보 관리', amount: 1.0, description: '댐 안전 관리, 수량 조절, 수력발전', recipient: '한국수자원공사' },
        ],
      },
    ],
  },
  ...
  'agriculture': {
    ...
    percentage: 3.3,
    yoy_change: 4.5,
    description: '농업·어업인 소득 지원, 식량 안보, 농촌 개발, 수산물 관리 등 1차 산업과 식품 안전을 위한 예산입니다.',
    why_it_matters: '한국의 식량 자급률은 약 45%(사료 포함 시 20% 미만)로 매우 낮습니다. 농업 예산은 식량 안보와 농어촌 지역 유지의 핵심입니다. 동시에 농업인 고령화(평균 66세)와 인구 감소로 농촌이 소멸 위기에 처해 있습니다.',
    who_benefits: '농업인 230만명, 어업인 12만명, 농식품 관련 기업, 전체 국민(식품 안전)',
    historical_trend: '2016년 18조 → 2026년 24조로 33% 증가. 쌀 과잉 생산에 따른 쌀값 안정 지원과 직불금 제도 개편이 주요 변화입니다.',
    controversy: '쌀값 보전 직불금이 대농(大農)에게 집중되는 문제, WTO 규정과의 충돌, 농지의 비농업적 전용(태양광 등) 논란이 있습니다.',
    related_ministry: '농림축산식품부, 해양수산부, 산림청',
    sub_items: [
      {
        id: 'direct-payment',
        name: '공익직불금',
        amount: 5.2,
        percentage: 21.5,
        description: '농업인에게 조건 없이(기본형) 또는 환경 보전 등 공익 활동 대가로(선택형) 지급하는 보조금입니다. 2020년부터 기존 쌀 직불금을 대체하여 시행되었습니다.',
        who_receives: '등록 농업인 약 130만명 (농지 0.5ha 이상 소유·경작)',
        how_it_works: '농업인이 농업경영체 등록 후 직불금을 신청합니다. 기본형은 면적에 따라(소농 120만원, 면적별 최대 250만원), 선택형은 친환경 농업·농촌 활력 프로그램 참여 시 추가 지급됩니다.',
        citizen_impact: '직불금 덕분에 농업인이 경작을 포기하지 않고 농사를 유지할 수 있습니다. 이는 곧 국내 식량 생산 유지와 농촌 경관 보전으로 이어집니다.',
        real_example: '충남 서산의 박민수 씨(71세)는 논 2ha(6,000평)를 경작하며 공익직불금 연 250만원을 받습니다. "쌀값이 떨어져도 직불금이 있어 농사를 계속할 수 있다"고 합니다.',
        trend: '2020년 도입 이후 소농 중심 지급으로 전환되었으나, 예산 규모는 2.5조 → 5.2조로 2배 증가하여 지원 강화 추세입니다.',
        issues: '실경작자가 아닌 부재지주(도시에 사는 토지 소유자)가 직불금을 받는 문제, 직불금이 농지 임대료만 올리는 효과 논란이 있습니다.',
        related_laws: ['농업·농촌 공익기능 증진 직접지불제도 운영에 관한 법률'],
        breakdown: [
          { name: '기본형 직불금', amount: 3.5, description: '농업인에게 면적·규모에 따라 기본 지급', recipient: '농업인 130만명' },
          { name: '선택형 직불금', amount: 1.2, description: '친환경 농업, 경관 보전 등 공익 활동 대가', recipient: '참여 농업인 15만명' },
          { name: '직불금 관리·운영', amount: 0.5, description: '농지 확인, 부정수급 점검 등', recipient: '농림축산식품부, 지자체' },
        ],
      },
      {
        id: 'food-security',
        ...
        amount: 4.8,
        percentage: 19.8,
        description: '쌀 수급 안정(과잉 시 정부 수매), 식량 비축, 밀·콩 등 전략작물 자급률 향상, 종자 개발 등의 예산입니다.',
        who_receives: '쌀 농가 80만 가구, 전략작물 전환 농가, 한국농수산식품유통공사',
        how_it_works: '정부가 쌀을 일정량 수매하여 비축하거나 가격이 급락하면 시장에서 격리합니다. 밀·콩 등 자급률이 낮은 작물로 전환하면 보조금을 지급합니다.',
        citizen_impact: '쌀값이 안정되면 소비자의 밥상 물가가 안정됩니다. 동시에 밀 자급률이 1% 미만이어서, 국제 밀 가격 급등 시(2022년 러시아-우크라이나 전쟁) 빵·라면 가격이 오르는 구조입니다.',
        real_example: '2022년 러시아-우크라이나 전쟁으로 국제 밀 가격이 2배 올랐을 때, 한국은 밀 자급률 1%여서 라면·빵 가격이 15~20% 올랐습니다. 정부는 이후 국내 밀 재배 지원을 3배 늘렸습니다.',
        trend: '쌀은 과잉인데 밀·콩·옥수수는 거의 수입에 의존하는 "식량 불균형"이 심화되고 있습니다. 전략작물 전환 지원이 확대 추세입니다.',
        issues: '매년 쌀이 남아 재고가 100만톤을 넘기면서 보관 비용만 연 5,000억원에 달합니다. 쌀 과잉 문제의 근본 해결이 필요합니다.',
        related_laws: ['양곡관리법', '농수산물 유통 및 가격안정에 관한 법률'],
        breakdown: [
          { name: '쌀 수매·비축', amount: 2.5, description: '정부 양곡 수매, 비축미 관리', recipient: '쌀 농가, 양곡유통업체' },
          { name: '전략작물 전환 지원', amount: 1.5, description: '밀·콩 등으로 전환하는 농가에 보조금', recipient: '전환 농가 3만 가구' },
          { name: '종자 개발·식량 R&D', amount: 0.8, description: '신품종 개발, 스마트팜 기술 연구', recipient: '농촌진흥청, 연구기관' },
        ],
      },
      {
        ...
        amount: 5.5,
        percentage: 22.7,
        description: '농촌 도로·상하수도 정비, 귀농·귀촌 지원, 농촌 의료·교육 접근성 향상 등 농촌 생활 환경을 개선하는 예산입니다.',
        who_receives: '농촌 지역 주민 약 900만명, 귀농·귀촌인 연 50만명',
        how_it_works: '농림축산식품부와 지자체가 협력하여 마을 단위 개발 사업(도로, 주거, 커뮤니티센터 등)을 추진합니다. 귀농인에게는 정착자금(최대 3억원 저리 대출)을 지원합니다.',
        citizen_impact: '농촌에 사는 사람도 도시와 비슷한 생활 인프라를 누릴 수 있도록 돕습니다. 하지만 현실은 농촌 버스가 하루 3편이고, 가장 가까운 병원까지 차로 30분인 마을이 많습니다.',
        real_example: '전남 곡성군은 귀농·귀촌 지원으로 젊은 농부 200가구를 유치했습니다. 체험 마을, 로컬 카페, 팜스테이 등으로 관광 수입도 연 50억원으로 늘었습니다.',
        trend: '농촌 인구 감소(1990년 650만 → 2026년 230만)로 마을 소멸이 가속화. 정부는 "농촌 재생 뉴딜"로 대응하고 있으나 효과는 제한적입니다.',
        issues: '인구가 10명 미만인 "한계 마을"이 전국 2,500곳에 달합니다. 마을마다 인프라를 유지하는 것이 효율적인지, 거점 마을로 통합해야 하는지 논쟁이 있습니다.',
        related_laws: ['농어촌정비법', '귀농·귀촌 활성화 및 지원에 관한 법률'],
        breakdown: [
          { name: '농촌 인프라 정비', amount: 3.0, description: '농촌 도로, 상하수도, 주거 환경 개선', recipient: '농촌 지자체' },
          { name: '귀농·귀촌 지원', amount: 1.5, description: '정착자금 대출, 영농 교육, 주택 지원', recipient: '귀농·귀촌인 연 50만명' },
          { name: '농촌 활력 사업', amount: 1.0, description: '마을 공동체 활성화, 체험 관광, 로컬 푸드', recipient: '농촌 마을 5천 곳' },
        ],
      },
      {
        id: 'fisheries',
        ...
        amount: 3.8,
        percentage: 15.7,
        description: '어업인 소득 지원, 수산물 관리, 불법 어업 단속, 어항 시설, 양식 산업 육성 등의 예산입니다.',
        who_receives: '어업인 약 12만명, 양식업자, 수산물 가공업체, 해양경찰(단속)',
        how_it_works: '해양수산부가 어선 유류비 보조, 수산물 수매·비축, 양식 기술 지원, 어항 시설 관리 등을 수행합니다.',
        citizen_impact: '한국인 1인당 수산물 소비량은 연 58kg으로 세계 최고 수준입니다. 수산물 가격 안정과 안전한 식품 공급이 이 예산의 핵심 목표입니다.',
        real_example: '통영의 한 굴 양식업자는 정부 지원으로 스마트 양식 시스템(수온·염분 자동 모니터링)을 도입하여 생산량이 30% 증가하고 폐사율이 절반으로 줄었습니다.',
        trend: '기후변화로 어종 분포가 변하면서 (명태 실종, 오징어 감소) 양식 산업 중심으로 전환 중입니다.',
        issues: '일본 후쿠시마 오염수 방류 이후 수산물 안전성 우려가 높아졌습니다. 수산물 방사능 검사 강화에 추가 예산이 필요하다는 의견이 있습니다.',
        related_laws: ['수산업법', '양식산업발전법'],
      },
      {
        id: 'forestry',
        name: '산림·산불 관리',
        amount: 4.9,
        percentage: 20.3,
        description: '산림 조성·관리, 산불 예방·진화, 산사태 방지, 임업인 지원, 탄소흡수원(숲) 관리 등의 예산입니다.',
        who_receives: '산림청, 산불 진화 인력, 임업인, 산촌 주민',
        how_it_works: '산림청이 국유림 관리, 사유림 지원, 산불 예방·진화 체계를 운영합니다. 산불 발생 시 산림헬기와 지상 진화 인력이 투입됩니다.',
        citizen_impact: '대형 산불(2022년 강원 산불, 2025년 산청 산불)은 주민 대피와 재산 피해를 일으킵니다. 산림은 도시인의 여가 공간이자, 수원 함양·탄소 흡수 등 공익적 기능도 합니다.',
        real_example: '2025년 산청·하동 산불은 서울 면적의 1/3에 해당하는 산림을 태웠습니다. 산림청은 진화 예산 5,000억원을 긴급 투입하고, 이후 산불 예방 예산을 2배로 증액했습니다.',
        trend: '기후변화(건조해지는 봄)로 대형 산불이 증가하면서 산불 대응 예산이 급증하고 있습니다.',
        issues: '산불 진화 인력과 장비 부족: 산림 헬기 50대로는 동시다발 산불에 대응하기 어렵습니다. 산불 감시 드론, AI 예측 시스템 도입이 필요하다는 지적이 있습니다.',
        related_laws: ['산림보호법', '산림자원의 조성 및 관리에 관한 법률'],
        breakdown: [
          { name: '산불 예방·진화', amount: 2.0, description: '산불 감시, 진화 인력·헬기 운영, 방화선 구축', recipient: '산림청·지자체' },
          { name: '산림 조성·관리', amount: 1.5, description: '나무 심기, 숲 가꾸기, 목재 산업', recipient: '산림청, 임업인' },
          { name: '산사태 방지·복구', amount: 1.4, description: '산사태 위험지역 정비, 사방 사업', recipient: '산촌 주민, 지자체' },
        ],
      },
    ],
  },
  ...
  'environment': {
    ...
    percentage: 1.9,
    yoy_change: 9.5,
    description: '대기오염 관리, 폐기물 처리, 수질 관리, 기후변화 대응, 자연 보전 등 환경을 보호하고 지속가능한 발전을 추구하는 예산입니다.',
    why_it_matters: '미세먼지, 플라스틱 오염, 기후변화는 모든 국민의 건강과 삶의 질에 직결됩니다. 한국은 2050 탄소중립을 선언했으며, 이를 위한 투자가 매년 늘고 있습니다.',
    who_benefits: '전체 국민(깨끗한 공기·물), 환경산업 종사자, 미래 세대',
    historical_trend: '2016년 7조 → 2026년 14조로 100% 증가. 미세먼지 대책(2019년~)과 탄소중립 정책(2021년~)이 예산 증가의 주요 원인입니다.',
    controversy: '환경 규제 강화 vs 산업 경쟁력 논쟁이 핵심입니다. "기후위기에 더 과감한 투자가 필요하다"는 환경단체와 "규제가 기업을 옥죈다"는 경제계가 대립합니다.',
    related_ministry: '환경부, 기상청',
    sub_items: [
      {
        id: 'air-quality',
        name: '대기질 관리(미세먼지)',
        amount: 3.2,
        percentage: 23.7,
        description: '미세먼지·초미세먼지 저감, 노후 경유차 교체 지원, 산업 배출 규제, 대기 관측망 운영 등의 예산입니다.',
        who_receives: '노후 차량 소유자(교체 지원), 산업 시설(방지 시설 지원), 전국 대기측정소 500곳',
        how_it_works: '환경부가 대기 오염 측정 → 기준 초과 시 비상저감조치 → 노후 경유차 운행 제한·폐차 지원 → 산업 시설 배출 규제 순으로 관리합니다.',
        citizen_impact: '미세먼지 "나쁨" 일수가 2019년 72일 → 2025년 35일로 절반 가까이 줄었습니다. 노후 경유차를 교체하면 최대 600만원 보조금을 받을 수 있습니다.',
        real_example: '서울의 한 택시기사는 2015년식 경유 택시를 전기택시로 교체할 때 정부 보조금 1,800만원 + 서울시 보조금 400만원을 받았습니다. 연료비도 월 40만원 → 8만원으로 절약되었습니다.',
        trend: '국내 미세먼지 배출은 줄고 있으나, 중국발 미세먼지의 영향은 여전합니다. 한·중 환경 협력이 과제입니다.',
        issues: '미세먼지 원인을 둘러싼 논쟁: "국내 배출이 주원인"(환경부) vs "중국발이 60% 이상"(일부 연구)으로 의견이 갈립니다.',
        related_laws: ['미세먼지 저감 및 관리에 관한 특별법', '대기환경보전법'],
        breakdown: [
          { name: '노후 차량 교체 지원', amount: 1.5, description: '경유차→전기차 전환 보조금, 조기 폐차 지원', recipient: '노후 차량 소유자 20만명' },
          { name: '산업 배출 저감', amount: 1.0, description: '사업장 방지 시설 설치, 배출 모니터링', recipient: '산업 시설 3만 곳' },
          { name: '대기 관측·예보', amount: 0.7, description: '대기측정소 운영, 미세먼지 예보 시스템', recipient: '환경부, 국립환경과학원' },
        ],
      },
      {
        id: 'waste-management',
        ...
        amount: 3.5,
        percentage: 25.9,
        description: '생활 쓰레기·산업 폐기물 처리, 재활용 체계, 플라스틱 감축, 불법 투기 단속 등의 예산입니다.',
        who_receives: '지자체(쓰레기 수거·처리), 재활용 업체, 폐기물 처리 업체',
        how_it_works: '종량제 봉투 판매 수입 + 생산자 부담금 + 정부 지원금으로 폐기물을 관리합니다. 분리수거 → 선별 → 재활용/소각/매립의 체계입니다.',
        citizen_impact: '매일 내놓는 분리수거, 음식물 쓰레기 처리가 원활하게 되는 것이 이 예산의 역할입니다. 1인당 하루 생활 폐기물은 약 0.9kg으로, 연간 처리 비용은 1인당 약 15만원입니다.',
        real_example: '수원시는 AI 분리수거 로봇을 시범 도입하여 재활용률이 62% → 78%로 상승했습니다. 잘못 분류된 쓰레기를 AI가 자동으로 골라내는 시스템입니다.',
        trend: '1회용품 규제, 포장재 감량, 보증금제(빈 병·캔 반환) 확대로 폐기물 감량을 추진하고 있습니다.',
        issues: '재활용 현실: 분리수거해도 실제 재활용되는 비율은 60% 수준입니다. 나머지는 소각·매립됩니다. "분리수거는 의미 없다"는 회의적 시각이 있으나, 분리수거가 없으면 더 나빠집니다.',
        related_laws: ['자원순환기본법', '폐기물관리법'],
        breakdown: [
          { name: '생활폐기물 처리 지원', amount: 1.5, description: '소각장·매립지 운영, 수거 체계 개선', recipient: '지자체 243곳' },
          { name: '재활용 산업 육성', amount: 1.2, description: '재활용 선별시설 현대화, 업사이클 지원', recipient: '재활용 업체 5천 곳' },
          { name: '플라스틱·1회용품 감축', amount: 0.8, description: '다회용기 보급, 생분해 소재 개발 지원', recipient: '음식점·카페·소비자' },
        ],
      },
      {
        id: 'climate-response',
        ...
        amount: 2.8,
        percentage: 20.7,
        description: '온실가스 감축, 탄소배출권 거래제 운영, 기후 적응(폭염·홍수 대비), 기후 관측·예측 등의 예산입니다.',
        who_receives: '산업체(탄소 감축 투자), 지자체(기후 적응 사업), 기상청',
        how_it_works: '탄소배출권 거래제로 기업에 배출 한도를 정하고, 초과 시 배출권을 구매하게 합니다. 기후 적응 사업으로 도시 열섬 완화(쿨링 포그), 홍수 대비(빗물 저류시설) 등을 추진합니다.',
        citizen_impact: '폭염 일수가 10년 전 대비 2배 증가했습니다. 도시 쿨링 시설(그늘막, 쿨링포그), 무더위 쉼터 운영이 이 예산에서 나옵니다. 겨울 한파 대비도 포함됩니다.',
        real_example: '대구시는 전국에서 가장 더운 도시로, 정부 지원을 받아 도심에 "바람길 숲"을 조성했습니다. 도시 열섬 효과를 3~5도 낮추고, 시민 산책 공간도 제공합니다.',
        trend: '2050 탄소중립 목표 달성을 위해 기후 예산이 매년 15% 이상 증가하고 있습니다. ESG 경영 확산으로 기업의 탄소 감축 투자도 늘고 있습니다.',
        issues: '한국의 1인당 온실가스 배출량은 OECD 평균보다 30% 높습니다. "2050 탄소중립은 불가능하다"는 비관론과 "기술 혁신으로 가능하다"는 낙관론이 대립합니다.',
        related_laws: ['탄소중립기본법', '기후위기 대응을 위한 탄소중립·녹색성장 기본법'],
        breakdown: [
          { name: '온실가스 감축 지원', amount: 1.2, description: '산업체 탄소 감축 설비, 배출권 거래제 운영', recipient: '산업체 600곳' },
          { name: '기후 적응 사업', amount: 1.0, description: '폭염·홍수 대비 인프라, 무더위 쉼터', recipient: '지자체·취약 계층' },
          { name: '기후 관측·예측', amount: 0.6, description: '기상위성, 기후변화 시나리오 연구', recipient: '기상청, 연구기관' },
        ],
      },
      {
        id: 'water-quality',
        ...
        amount: 2.5,
        percentage: 18.5,
        description: '4대강·하천 수질 관리, 하수처리장 운영, 먹는물 수질 감시, 해양 오염 방지 등의 예산입니다.',
        who_receives: '지자체(하수처리), 환경관리공단, 수도 사업자',
        how_it_works: '전국 하수처리장 4,200곳을 운영하여 생활하수와 산업폐수를 정화합니다. 하천 수질을 실시간 모니터링하고, 기준 초과 시 오염원을 추적합니다.',
        citizen_impact: '수돗물 수질과 하천·바다의 깨끗함에 직결됩니다. 한강·낙동강 수질이 30년 전 대비 크게 개선되어 물놀이·낚시가 가능해진 곳이 많습니다.',
        real_example: '낙동강 수질이 1990년대 5등급(악취) → 현재 2등급(수영 가능)으로 개선되었습니다. 부산 시민의 수돗물 원수인 낙동강 관리에만 연 3,000억원이 투입됩니다.',
        trend: '하수관 노후화(30년 이상 32%)로 정비 수요가 급증하고 있습니다. 미세 플라스틱·의약물질 등 신종 오염물질 관리도 새로운 과제입니다.',
        issues: '낙동강 수질 갈등: 상류(대구·구미) 오·폐수가 하류(부산) 수돗물에 영향을 주는 구조적 문제가 지속되고 있습니다.',
        related_laws: ['물환경보전법', '수도법'],
        breakdown: [
          { name: '하수처리 시설 운영', amount: 1.2, description: '하수처리장 4,200곳 운영 및 시설 개선', recipient: '지자체' },
          { name: '하천 수질 관리', amount: 0.8, description: '수질 모니터링, 오염원 관리, 수생태 복원', recipient: '유역환경청, 지자체' },
          { name: '먹는물·해양 관리', amount: 0.5, description: '수돗물 수질 검사, 해양 쓰레기 수거', recipient: '수도 사업자, 해양 관리' },
        ],
      },
      {
        ...
        amount: 1.5,
        percentage: 11.1,
        description: '국립공원 관리, 생물 다양성 보전, 멸종위기종 보호, 생태계 복원 등의 예산입니다.',
        who_receives: '국립공원공단, 환경부 산하 기관, 생태계 보전 지역 주민',
        how_it_works: '국립공원 22곳을 관리하고, 멸종위기종(반달가슴곰, 수달, 독수리 등) 복원 프로그램을 운영합니다. 습지 보전, 도시 생태계(도시 공원 연결) 사업도 포함됩니다.',
        citizen_impact: '국립공원을 무료로 이용할 수 있는 것이 이 예산 덕분입니다. 연간 국립공원 탐방객은 약 4,700만명으로 국민 대부분이 혜택을 받습니다.',
        real_example: '지리산 반달가슴곰 복원 사업(2004년~)으로 방사된 8마리에서 현재 약 80마리로 개체수가 10배 증가했습니다. 야생에서 새끼를 낳아 자생 가능한 수준에 도달했습니다.',
        trend: '생물다양성 국제 협약(쿤밍-몬트리올 프레임워크)에 따라 2030년까지 국토의 30%를 보호구역으로 지정하는 "30x30" 목표를 추진 중입니다.',
        related_laws: ['자연환경보전법', '야생생물 보호 및 관리에 관한 법률'],
      },
    ],
  },
  ...
  'culture': {
    ...
    percentage: 1.3,
    yoy_change: 6.8,
    description: '문화예술 지원, 체육 진흥, 관광 산업 육성, 문화재 보존, 콘텐츠 산업(K-콘텐츠) 지원 등의 예산입니다.',
    why_it_matters: 'K-팝, K-드라마, K-영화가 세계를 휩쓸면서 "문화 산업"이 한국의 새로운 먹거리가 되고 있습니다. 콘텐츠 수출은 2025년 기준 약 130억 달러로 반도체에 이은 수출 효자입니다.',
    who_benefits: '문화예술인 30만명, 체육인 5만명, 관광업 종사자 270만명, 전체 국민(문화 향유)',
    historical_trend: '2016년 6조 → 2026년 9조로 50% 증가. K-콘텐츠 수출 급증에 따라 콘텐츠 산업 지원이 크게 늘었습니다.',
    controversy: '문화예술 지원의 공정성 (블랙리스트 사태 이후), 대형 스포츠 이벤트 유치의 실효성, 관광 인프라 부족 등이 논쟁점입니다.',
    related_ministry: '문화체육관광부, 문화재청',
    sub_items: [
      {
        id: 'k-content',
        name: 'K-콘텐츠 산업',
        amount: 2.5,
        percentage: 27.2,
        description: 'K-팝, K-드라마, 게임, 웹툰 등 한국 콘텐츠 산업을 지원하는 예산입니다. 해외 진출 지원, 제작 인프라 구축, 인력 양성 등이 포함됩니다.',
        who_receives: '콘텐츠 제작사, 한국콘텐츠진흥원(KOCCA), 인디 창작자, 콘텐츠 관련 스타트업',
        how_it_works: '한국콘텐츠진흥원이 콘텐츠 기업의 해외 진출, 국제 전시 참가, 현지화(번역·더빙) 비용을 지원합니다. 스튜디오·촬영장 인프라 구축, 신인 창작자 발굴도 추진합니다.',
        citizen_impact: '한류 콘텐츠가 세계적으로 인기를 얻으면서 관련 산업(관광, 식품, 패션, 뷰티)이 함께 성장합니다. "오징어게임" 하나로 넷플릭스에서 약 1조원의 경제적 효과가 발생했습니다.',
        real_example: '한국콘텐츠진흥원의 지원을 받은 인디 게임사 "팀 체리블라섬"은 글로벌 게임 전시회(도쿄 게임쇼)에 참가하여 일본 퍼블리셔와 계약을 맺었습니다. 직원 8명의 소규모 회사가 연매출 50억원을 달성했습니다.',
        trend: 'K-콘텐츠 수출이 2019년 100억 달러 → 2025년 130억 달러로 급성장. 정부 지원도 이에 맞춰 확대 중입니다.',
        issues: '대기업 중심 지원이라는 비판이 있습니다. 넷플릭스·카카오 등 대형 플랫폼이 혜택을 독점하고, 실제 창작자의 처우는 열악하다는 문제가 있습니다.',
        related_laws: ['콘텐츠산업진흥법', '문화산업진흥기본법'],
        breakdown: [
          { name: '콘텐츠 해외 진출', amount: 1.0, description: '해외 전시, 현지화 비용, 마케팅 지원', recipient: '콘텐츠 기업 2천 곳' },
          { name: '제작 인프라·기술', amount: 0.8, description: '가상 스튜디오, VFX 기술, 촬영 장비 지원', recipient: '제작사·스튜디오' },
          { name: '인력 양성·창작 지원', amount: 0.7, description: '신인 창작자 발굴, 콘텐츠 아카데미 운영', recipient: '창작자·예비 인력' },
        ],
      },
      {
        id: 'arts-support',
        ...
        amount: 2.0,
        percentage: 21.7,
        description: '문화예술인 창작 활동 지원, 공공 문화시설(도서관, 미술관, 공연장) 운영, 문화 향유 프로그램, 예술인 복지 등의 예산입니다.',
        who_receives: '문화예술인 30만명, 공공 문화시설 3,500곳, 문화예술 단체, 일반 국민',
        how_it_works: '한국문화예술위원회가 예술가에게 창작 지원금을 지급하고, 지자체가 도서관·미술관·공연장을 운영합니다. 통합문화이용권(문화누리카드)으로 저소득층의 문화 향유를 지원합니다.',
        citizen_impact: '문화누리카드(연 11만원)로 영화, 공연, 도서 구입, 여행 등을 이용할 수 있습니다. 공공 도서관 1,200곳은 무료로 책을 빌릴 수 있는 시민의 지식 인프라입니다.',
        real_example: '기초생활수급자인 서울 관악구의 한 가정은 4인가족 문화누리카드 합계 44만원으로 연 6회 영화 관람, 어린이 뮤지컬 관람, 서점에서 책 구입 등을 합니다. "돈이 없어서 문화생활을 못 했는데, 카드 덕분에 아이들에게 다양한 경험을 시켜줄 수 있다"고 합니다.',
        trend: '코로나 이후 문화예술계가 큰 타격을 받았고, 예술인 긴급지원이 확대되었습니다. 2025년부터 예술인 고용보험이 안정화 단계에 접어들었습니다.',
        issues: '2016년 박근혜 정부의 "문화예술 블랙리스트" 사태 이후 지원의 독립성과 공정성이 핵심 과제입니다. 정치적 이유로 지원을 배제하면 안 된다는 원칙이 확립되었습니다.',
        related_laws: ['문화예술진흥법', '예술인 복지법'],
        breakdown: [
          { name: '예술인 창작 지원', amount: 0.8, description: '창작 지원금, 레지던시, 해외 교류', recipient: '예술인 3만명' },
          { name: '문화시설 운영', amount: 0.7, description: '공공 도서관, 미술관, 공연장 운영비', recipient: '문화시설 3,500곳' },
          { name: '문화 향유 지원', amount: 0.5, description: '문화누리카드, 통합문화이용권, 열린 문화행사', recipient: '저소득층 250만명' },
        ],
      },
      {
        id: 'tourism',
        ...
        amount: 1.8,
        percentage: 19.6,
        description: '외국인 관광 유치, 관광 인프라 구축, 관광지 개발, 한국관광공사 운영 등의 예산입니다.',
        who_receives: '관광업 종사자 270만명, 한국관광공사, 관광지 지자체',
        how_it_works: '한국관광공사가 해외 홍보(한류 연계), 관광 마케팅, 의료관광·K-뷰티 관광 유치를 추진합니다. 지자체의 관광지 정비, 야간관광 활성화 등도 지원합니다.',
        citizen_impact: '외래 관광객 1,800만명(2025년)이 쓰는 돈은 약 25조원으로, 관광지 상인·숙박업·교통업에 직접 영향을 줍니다. 관광 인프라 개선은 국내 여행객에게도 혜택입니다.',
        real_example: '한국관광공사의 "한류 관광 패키지"로 방한한 태국 관광객이 2023년 30만명 → 2025년 80만명으로 급증했습니다. 명동·홍대 상권의 매출이 30% 이상 증가했습니다.',
        trend: '코로나 후 관광 V자 회복, 2025년 외래 관광객이 역대 최고를 기록할 전망입니다. K-콘텐츠 팬덤 관광이 새로운 트렌드입니다.',
        issues: '관광 인프라 부족: 서울·부산 외 지방 관광이 미흡합니다. 외국인 관광객의 80%가 서울에 집중되어 지방 관광 활성화가 과제입니다.',
        related_laws: ['관광진흥법', '관광기본법'],
        breakdown: [
          { name: '해외 마케팅·유치', amount: 0.8, description: '해외 홍보, 한류 연계 마케팅, 전시·행사', recipient: '한국관광공사' },
          { name: '관광 인프라 정비', amount: 0.6, description: '관광지 환경 개선, 안내 시스템, 화장실 등', recipient: '관광지 지자체' },
          { name: '지역 관광 활성화', amount: 0.4, description: '농촌 관광, 야간관광, 테마 관광 코스 개발', recipient: '비수도권 지자체' },
        ],
      },
      {
        ...
        amount: 1.5,
        percentage: 16.3,
        description: '국보·보물 등 문화재 보수·관리, 궁궐·왕릉 관리, 무형문화재 전승 지원, 발굴 조사 등의 예산입니다.',
        who_receives: '문화재청, 문화재 소유자(사찰 등), 무형문화재 보유자, 발굴 기관',
        how_it_works: '문화재청이 국가지정 문화재(국보 370점, 보물 2,200점 등)의 보수·관리를 총괄합니다. 사유 문화재 보수에는 국비 70% + 지방비 30%를 지원합니다.',
        citizen_impact: '경복궁·불국사 등 문화재 관람은 한국인의 자긍심이자 관광 자원입니다. 궁궐 야간 개장, 문화재 해설 프로그램 등으로 시민의 접근성이 높아지고 있습니다.',
        real_example: '숭례문(남대문) 복원 사업(2008~2013년, 270억원)은 국보 1호의 재건으로 국민적 관심을 받았습니다. 전통 기법으로 복원하여 조선 시대 건축 기술의 가치를 보존했습니다.',
        trend: '디지털 문화재(3D 스캔, 디지털 복원) 투자가 늘고 있으며, K-heritage 관광 활성화로 문화재 활용 예산이 증가 추세입니다.',
        issues: '문화재 보수에 전통 기법 장인이 부족합니다. 단청, 한식 목조 기술 등을 전수받을 청년이 줄어들어 기술 단절 위험이 있습니다.',
        related_laws: ['문화재보호법'],
      },
      {
        id: 'sports',
        ...
        amount: 1.4,
        percentage: 15.2,
        description: '생활체육 시설 확충, 전문체육(국가대표) 지원, 학교 체육, 장애인 체육 등의 예산입니다.',
        who_receives: '체육 동호회·클럽, 국가대표 선수, 학생, 체육 시설 이용 시민',
        how_it_works: '국민체육진흥공단이 체육시설 건립, 동호회 활동 지원, 스포츠 바우처(저소득층) 등을 운영합니다. 전문체육은 대한체육회를 통해 국가대표 훈련·대회 참가를 지원합니다.',
        citizen_impact: '동네 체육관, 수영장, 축구장 등 공공 체육시설을 저렴하게(또는 무료로) 이용할 수 있는 것이 이 예산 덕분입니다. 스포츠 바우처로 저소득 가정 자녀도 태권도·수영 등을 배울 수 있습니다.',
        real_example: '경기도 시흥의 국민체육센터는 월 3만원으로 수영·헬스를 이용할 수 있습니다. 민간 시설(월 10~15만원)의 1/3~1/5 가격입니다. 연 이용자 20만명으로 주민 건강 증진에 기여하고 있습니다.',
        trend: '생활체육 참여율이 2016년 55% → 2026년 70%로 증가하면서 시설 수요가 늘고 있습니다. 반면 전문체육(올림픽 성적) 집중 투자는 줄이는 추세입니다.',
        issues: '학교 운동부의 폭력·학대 문제가 지속 제기됩니다. 스포츠 인권 보장과 선수 보호가 중요한 과제입니다.',
        related_laws: ['국민체육진흥법', '스포츠기본법'],
        breakdown: [
          { name: '생활체육 시설·프로그램', amount: 0.6, description: '공공 체육시설 건립, 동호회 지원, 스포츠 바우처', recipient: '전국 시민' },
          { name: '전문체육·국가대표', amount: 0.5, description: '국가대표 훈련, 국제대회 참가, 체육과학 연구', recipient: '국가대표 선수 2천명' },
          { name: '학교체육·장애인체육', amount: 0.3, description: '학교 운동부 지원, 장애인 체육시설, 파라스포츠', recipient: '학생·장애인 체육인' },
        ],
      },
    ],
  },
...
export function getSectorDetail(sectorId: string): SectorDetail | undefined {
  return SECTOR_DETAILS[sectorId];
}

export function getAllSectorDetails(): SectorDetail[] {
  return Object.values(SECTOR_DETAILS);
}

export function getSectorIdByName(name: string): string | undefined {
  return Object.entries(SECTOR_DETAILS).find(([_, v]) => v.name === name)?.[0];
}

// ========================================
// 국제 비교 데이터 (data/seed/international_comparison.json 기반)
// ========================================

const INTERNATIONAL_COMPARISONS: InternationalComparison[] = [
  {
    metric_id: 'debt_to_gdp',
    metric_name: 'GDP 대비 국가채무',
    unit: '%',
    year: 2024,
    description: '국가가 빌린 돈(국채 등)이 1년 GDP 대비 얼마인지를 보여주는 지표입니다. 가계로 치면 연봉 대비 대출 잔액 비율과 같습니다.',
    why_it_matters: '국가채무가 과도하면 이자 부담이 커져 복지·교육 등에 쓸 돈이 줄어듭니다. 한국은 OECD 기준으로 아직 양호하지만, 고령화·저출산으로 빠르게 증가하는 추세가 우려됩니다.',
    korea_position: 'OECD 하위권 (양호)',
    lower_is_better: true,
    countries: [
      { country: '일본', country_en: 'Japan', value: 260.0 },
      { country: '그리스', country_en: 'Greece', value: 162.0 },
      { country: '이탈리아', country_en: 'Italy', value: 137.0 },
      { country: '미국', country_en: 'USA', value: 121.0 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 112.0 },
      { country: '프랑스', country_en: 'France', value: 110.0 },
      { country: '영국', country_en: 'UK', value: 101.0 },
      { country: '독일', country_en: 'Germany', value: 63.0 },
      { country: '대한민국', country_en: 'South Korea', value: 54.3, is_korea: true }, // IMF GFS 기준 (한국 정부 D1 기준 46.8%)
    ],
  },
  {
    metric_id: 'gov_spending_gdp',
    metric_name: 'GDP 대비 정부지출',
    unit: '%',
    year: 2024,
    description: '정부가 1년 동안 쓰는 돈이 GDP 대비 얼마인지를 나타냅니다. 복지·국방·교육 등 모든 정부 지출을 포함합니다.',
    why_it_matters: '정부지출 비율이 높으면 "큰 정부"로 복지가 두터운 반면 세금 부담도 큽니다. 한국은 OECD 중 가장 낮은 수준으로, 그만큼 개인이 부담하는 비용(교육비, 의료비)이 큰 편입니다.',
    korea_position: 'OECD 최하위권',
    lower_is_better: false,
    countries: [
      { country: '프랑스', country_en: 'France', value: 57.0 },
      { country: '이탈리아', country_en: 'Italy', value: 50.0 },
      { country: '독일', country_en: 'Germany', value: 48.0 },
      { country: '영국', country_en: 'UK', value: 43.0 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 42.0 },
      { country: '일본', country_en: 'Japan', value: 40.0 },
      { country: '미국', country_en: 'USA', value: 36.0 },
      { country: '대한민국', country_en: 'South Korea', value: 28.0, is_korea: true },
    ],
  },
  {
    ...
    unit: '명',
    year: 2024,
    description: '여성 1명이 평생 낳을 것으로 예상되는 아이 수입니다. 인구 유지에 필요한 수준은 약 2.1명입니다.',
    why_it_matters: '출산율이 낮으면 미래 노동인구가 줄고 연금·건강보험 재정이 악화됩니다. 한국의 0.72명은 전 세계 최저 수준으로, 인구 소멸 위기라는 경고가 나오고 있습니다.',
    korea_position: 'OECD 최하위 (세계 최저)',
    lower_is_better: false,
    countries: [
      { country: '프랑스', country_en: 'France', value: 1.68 },
      { country: '미국', country_en: 'USA', value: 1.62 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 1.51 },
      { country: '독일', country_en: 'Germany', value: 1.36 },
      { country: '이탈리아', country_en: 'Italy', value: 1.24 },
      { country: '일본', country_en: 'Japan', value: 1.20 },
      { country: '대한민국', country_en: 'South Korea', value: 0.72, is_korea: true },
    ],
  },
  {
    metric_id: 'unemployment',
    metric_name: '실업률',
    unit: '%',
    year: 2024,
    description: '일할 능력과 의사가 있으나 일자리를 찾지 못한 사람의 비율입니다. 실질적인 고용 상태를 보여주는 핵심 지표입니다.',
    why_it_matters: '실업률은 경제 건강의 바로미터입니다. 한국은 수치상 낮지만, 청년 실업률(약 6%)이나 비정규직 비율을 함께 봐야 전체 고용의 질을 파악할 수 있습니다.',
    korea_position: 'OECD 상위권 (양호)',
    lower_is_better: true,
    countries: [
      { country: '스페인', country_en: 'Spain', value: 11.8 },
      { country: '이탈리아', country_en: 'Italy', value: 6.7 },
      { country: '프랑스', country_en: 'France', value: 7.3 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 5.1 },
      { country: '미국', country_en: 'USA', value: 4.0 },
      { country: '독일', country_en: 'Germany', value: 3.1 },
      { country: '대한민국', country_en: 'South Korea', value: 2.8, is_korea: true },
      { country: '일본', country_en: 'Japan', value: 2.5 },
    ],
  },
  {
    ...
    unit: '$',
    year: 2024,
    description: 'GDP를 인구수로 나눈 값으로, 국민 1인이 평균적으로 생산하는 부가가치입니다. 국가의 생활 수준을 대략적으로 비교하는 데 쓰입니다.',
    why_it_matters: '1인당 GDP는 국가 경제력의 기본 척도입니다. 한국은 3만 달러 시대에 진입했지만, 구매력 기준이나 불평등을 고려하면 체감 경제력은 다를 수 있습니다.',
    korea_position: 'OECD 중위권',
    lower_is_better: false,
    countries: [
      { country: '미국', country_en: 'USA', value: 80035 },
      { country: '독일', country_en: 'Germany', value: 52824 },
      { country: '영국', country_en: 'UK', value: 48913 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 47500 },
      { country: '프랑스', country_en: 'France', value: 44408 },
      { country: '이탈리아', country_en: 'Italy', value: 36812 },
      { country: '일본', country_en: 'Japan', value: 34017 },
      { country: '대한민국', country_en: 'South Korea', value: 35500, is_korea: true },
    ],
  },
  {
    metric_id: 'corruption_index',
    metric_name: '부패인식지수',
    unit: '점 (0-100)',
    year: 2024,
    description: '국제투명성기구(Transparency International)가 매년 발표하는 공공부문 부패 인식 정도입니다. 100에 가까울수록 청렴합니다.',
    why_it_matters: '부패 수준은 정부 신뢰도와 직결됩니다. 한국은 63점으로 OECD 평균보다 약간 낮으며, 정경유착이나 공직자 비위 사건이 점수를 낮추는 요인입니다.',
    korea_position: 'OECD 중하위권',
    lower_is_better: false,
    countries: [
      { country: '덴마크', country_en: 'Denmark', value: 90 },
      { country: '독일', country_en: 'Germany', value: 78 },
      { country: '일본', country_en: 'Japan', value: 73 },
      { country: '프랑스', country_en: 'France', value: 71 },
      { country: '미국', country_en: 'USA', value: 69 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 68 },
      { country: '대한민국', country_en: 'South Korea', value: 64, is_korea: true },
      { country: '이탈리아', country_en: 'Italy', value: 57 },
    ],
  },
  {
    metric_id: 'defense_spending',
    metric_name: '국방비 GDP 비율',
    unit: '%',
    year: 2024,
    description: '국방 예산이 GDP에서 차지하는 비중입니다. 안보 상황, 동맹 관계, 군사 전략에 따라 국가마다 크게 다릅니다.',
    why_it_matters: '한국은 북한과의 군사적 대치 상황으로 OECD 평균보다 높은 국방비를 지출합니다. NATO 권고 기준(2%)을 넘는 수준이며, 이는 복지·교육 등 다른 분야 예산과의 균형 문제와 연결됩니다.',
    korea_position: 'OECD 상위권',
    lower_is_better: false,
    countries: [
      { country: '미국', country_en: 'USA', value: 3.4 },
      { country: '대한민국', country_en: 'South Korea', value: 2.4, is_korea: true },
      { country: '영국', country_en: 'UK', value: 2.3 },
      { country: '프랑스', country_en: 'France', value: 1.9 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 1.8 },
      { country: '독일', country_en: 'Germany', value: 2.1 },
      { country: '이탈리아', country_en: 'Italy', value: 1.5 },
      { country: '일본', country_en: 'Japan', value: 1.6 },
    ],
  },
  {
    metric_id: 'rd_spending',
    metric_name: 'R&D 투자 GDP 비율',
    unit: '%',
    year: 2024,
    description: '연구개발(R&D)에 투자하는 금액이 GDP에서 차지하는 비율입니다. 정부와 민간 투자를 모두 합산한 수치입니다.',
    why_it_matters: '한국은 세계 최고 수준의 R&D 투자국으로, 반도체·배터리·AI 등 기술 경쟁력의 원천입니다. 다만 기초과학보다 응용·개발 중심이라는 지적과, 대기업 쏠림 문제가 있습니다.',
    korea_position: 'OECD 최상위권 (세계 2위)',
    lower_is_better: false,
    countries: [
      { country: '이스라엘', country_en: 'Israel', value: 5.6 },
      { country: '대한민국', country_en: 'South Korea', value: 4.9, is_korea: true },
      { country: '미국', country_en: 'USA', value: 3.5 },
      { country: '일본', country_en: 'Japan', value: 3.3 },
      { country: '독일', country_en: 'Germany', value: 3.1 },
      { country: 'OECD 평균', country_en: 'OECD avg', value: 2.7 },
      { country: '프랑스', country_en: 'France', value: 2.2 },
      { country: '영국', country_en: 'UK', value: 1.7 },
    ],
  },
];

export function getInternationalComparisons(): InternationalComparison[] {
...
// 지방자치단체 데이터
// ========================================
// 재정자립도는 자체 세입이 전체 세입에서 차지하는 비중입니다.
// 높을수록 중앙정부에 의존하지 않고 자체 운영이 가능합니다.

const LOCAL_GOVERNMENTS_DATA: LocalGovernment[] = [
  {
    id: 'seoul',
    name: '서울특별시',
    name_short: '서울',
    ...
    debt: 5.8,
    debt_ratio: 12.8,
    fiscal_independence: 76.5,
    fiscal_self_reliance: 82.3,
    governor: '오세훈',
    governor_party: '국민의힘',
    key_issues: ['주택 공급 및 재개발', '대중교통 인프라 확충', '미세먼지 대책', '고령화 대응', '청년 주거 지원'],
    description: '대한민국의 수도이자 최대 도시. 전체 인구의 약 18%가 거주하며, 경제·문화·정치의 중심지입니다. 높은 재정자립도를 보유하고 있으나, 부동산 가격과 교통 혼잡이 핵심 과제입니다.',
    sub_regions_count: 25,
  },
  {
    id: 'busan',
    name: '부산광역시',
    ...
    debt: 2.1,
    debt_ratio: 13.3,
    fiscal_independence: 48.2,
    fiscal_self_reliance: 56.8,
    governor: '박형준',
    governor_party: '국민의힘',
    key_issues: ['인구 유출 대응', '항만 물류 허브 강화', '원도심 재생', '관광산업 육성'],
    description: '대한민국 제2의 도시이자 최대 항만도시. 해양·물류 산업의 중심이지만, 지속적인 인구 감소와 청년 유출이 가장 큰 과제입니다. 북항 재개발 등 대규모 도시 재생사업이 진행 중입니다.',
    sub_regions_count: 16,
    extinction_risk: '주의',
  },
  {
    id: 'daegu',
    ...
    debt: 1.5,
    debt_ratio: 14.3,
    fiscal_independence: 42.8,
    fiscal_self_reliance: 51.2,
    governor: '홍준표',
    governor_party: '국민의힘',
    key_issues: ['산업구조 전환', '인구 감소 대응', '의료·헬스케어 허브', '도심 활성화'],
    description: '영남 내륙의 중심 도시로, 섬유산업에서 첨단산업으로의 전환을 추진 중입니다. 의료 인프라가 강점이며, 국가산업단지를 기반으로 제조업 혁신을 모색하고 있습니다.',
    sub_regions_count: 8,
    extinction_risk: '주의',
  },
  {
    ...
    debt: 3.2,
    debt_ratio: 22.5,
    fiscal_independence: 52.1,
    fiscal_self_reliance: 59.5,
    governor: '유정복',
    governor_party: '국민의힘',
    key_issues: ['인천공항 경제권 확대', '원도심-신도시 균형 발전', '채무 관리', '수도권 교통망 확충', '서해안 환경보전'],
    description: '인천국제공항과 항만을 보유한 국제 관문도시. 경제자유구역과 송도·청라 등 신도시 개발이 진행되었으나, 높은 채무비율과 원도심 공동화가 과제입니다.',
    sub_regions_count: 10,
  },
  {
    id: 'gwangju',
    name: '광주광역시',
    ...
    debt: 0.8,
    debt_ratio: 11.8,
    fiscal_independence: 35.2,
    fiscal_self_reliance: 48.5,
    governor: '강기정',
    governor_party: '더불어민주당',
    key_issues: ['AI·미래차 산업 육성', '문화예술 도시 브랜딩', '인구 유출 방지', '광주형 일자리'],
    description: '호남의 중심 도시이자 민주화운동의 성지. AI 산업과 미래자동차(광주글로벌모터스) 등 신산업 육성에 주력하고 있으며, 아시아문화전당을 중심으로 문화도시를 지향합니다.',
    sub_regions_count: 5,
  },
  {
    id: 'daejeon',
    ...
    debt: 0.7,
    debt_ratio: 10.8,
    fiscal_independence: 38.5,
    fiscal_self_reliance: 50.2,
    governor: '이장우',
    governor_party: '국민의힘',
    key_issues: ['과학기술 혁신 허브', '대덕연구단지 활성화', '세종시와의 상생', '교통 인프라 개선'],
    description: '대한민국 과학기술의 중심. 대덕연구단지를 비롯한 연구기관이 밀집해 있으며, KTX 교통 거점으로서 접근성이 우수합니다. 세종시 행정수도 이전 이후 역할 재정립이 과제입니다.',
    sub_regions_count: 5,
  },
  {
    id: 'ulsan',
    ...
    debt: 0.5,
    debt_ratio: 8.6,
    fiscal_independence: 45.3,
    fiscal_self_reliance: 55.8,
    governor: '김두겸',
    governor_party: '국민의힘',
    key_issues: ['자동차·조선 산업 전환', '수소경제 선도', '환경오염 개선', '인구 유출 방지'],
    description: '현대자동차와 현대중공업 등이 소재한 대한민국 최대 산업도시. 1인당 GRDP가 전국 최고 수준이지만, 제조업 의존도가 높아 산업구조 전환이 시급합니다.',
    sub_regions_count: 5,
    extinction_risk: '관심',
  },
  {
    ...
    debt: 0.8,
    debt_ratio: 25.0,
    fiscal_independence: 42.0,
    fiscal_self_reliance: 52.3,
    governor: '최민호',
    governor_party: '무소속',
    key_issues: ['행정수도 완성', '자족기능 확충', '교통 인프라 구축', '인구 유입 관리'],
    description: '행정중심복합도시로 건설된 특별자치시. 중앙행정기관이 이전해 있으며, 급격한 인구 증가에 따른 인프라 확충이 과제입니다. 자족도시로서의 완성도를 높이는 것이 목표입니다.',
    sub_regions_count: 1,
  },
  {
    id: 'gyeonggi',
    ...
    debt: 4.5,
    debt_ratio: 12.6,
    fiscal_independence: 62.3,
    fiscal_self_reliance: 70.1,
    governor: '김동연',
    governor_party: '더불어민주당',
    key_issues: ['남북 균형 발전', '교통 혼잡 해소', '반도체 산업 지원', '신도시 인프라', '수도권 과밀 해소'],
    description: '대한민국 최대 인구 광역단체로, 전체 인구의 약 26%가 거주합니다. 삼성전자·SK하이닉스 등 반도체 클러스터가 있으며, 수도권 남부와 북부의 발전 격차 해소가 과제입니다.',
    sub_regions_count: 31,
  },
  {
    id: 'gangwon',
    name: '강원특별자치도',
    ...
    debt: 1.2,
    debt_ratio: 14.1,
    fiscal_independence: 22.5,
    fiscal_self_reliance: 42.8,
    governor: '김진태',
    governor_party: '국민의힘',
    key_issues: ['관광산업 고도화', '인구 소멸 대응', '접경지역 개발', '동계스포츠 인프라 활용', '산림자원 관리'],
    description: '산악·해양 자원이 풍부한 관광·휴양의 중심지. 2018 평창동계올림픽 이후 스포츠 인프라 활용이 과제이며, 접경지역 개발과 인구 소멸 위기에 대응하고 있습니다.',
    sub_regions_count: 18,
    extinction_risk: '위험',
  },
  {
    id: 'chungbuk',
    ...
    debt: 0.9,
    debt_ratio: 12.5,
    fiscal_independence: 25.8,
    fiscal_self_reliance: 45.2,
    governor: '김영환',
    governor_party: '국민의힘',
    key_issues: ['바이오산업 클러스터', '오송·오창 혁신도시', '내륙 교통망 확충', '농촌 활력 증진'],
    description: '대한민국 유일의 내륙 도(道). 오송바이오밸리와 반도체 소부장 클러스터가 성장 동력이며, 충주·제천 등 북부 지역의 인구 감소 대응이 필요합니다.',
  ...
  },
  {
    ...
    debt: 1.3,
    debt_ratio: 13.3,
    fiscal_independence: 28.5,
    fiscal_self_reliance: 47.8,
    governor: '김태흠',
    governor_party: '국민의힘',
    key_issues: ['석탄발전 전환', '내포신도시 활성화', '서해안 산업벨트', '농업 혁신', '세종시 연계 발전'],
    description: '서해안 산업벨트와 농업이 주력인 도. 당진·서산 등 임해산업단지가 있으며, 탈석탄 에너지 전환과 농촌 고령화가 핵심 과제입니다.',
    sub_regions_count: 15,
    extinction_risk: '관심',
  },
  {
    id: 'jeonbuk',
    ...
    debt: 1.1,
    debt_ratio: 12.5,
    fiscal_independence: 20.2,
    fiscal_self_reliance: 40.5,
    governor: '김관영',
    governor_party: '더불어민주당',
    key_issues: ['특별자치도 규제특례 활용', '탄소소재 산업', '새만금 개발', '농생명 산업 육성', '인구 유출 대응'],
    description: '2024년 특별자치도로 출범하여 규제특례를 활용한 성장을 모색 중입니다. 새만금 개발사업과 탄소소재·농생명 산업이 핵심 성장동력이며, 전국 최저 수준의 재정자립도가 과제입니다.',
    sub_regions_count: 14,
    extinction_risk: '위험',
  },
  {
    id: 'jeonnam',
    ...
    debt: 1.0,
    debt_ratio: 9.8,
    fiscal_independence: 15.8,
    fiscal_self_reliance: 38.2,
    governor: '김영록',
    governor_party: '더불어민주당',
    key_issues: ['에너지 신산업', '해양수산 활성화', '인구 소멸 대응', '농촌 복지 확충', '관광자원 개발'],
    description: '전국 최대 농수산물 생산지이자 신재생에너지 선도지역. 태양광·풍력 발전 등 에너지 전환에 앞장서고 있으나, 전국 최저 수준의 재정자립도와 심각한 고령화가 도전 과제입니다.',
    sub_regions_count: 22,
    extinction_risk: '심각',
  },
  {
    id: 'gyeongbuk',
    ...
    debt: 1.5,
    debt_ratio: 12.0,
    fiscal_independence: 20.5,
    fiscal_self_reliance: 42.5,
    governor: '이철우',
    governor_party: '국민의힘',
    key_issues: ['원전 산업 지원', '포항 철강 산업 전환', '경주·안동 문화관광', '농촌 소멸 대응', '동해안 개발'],
    description: '면적 기준 최대 광역단체. 포항의 철강, 구미의 전자산업이 기반이며, 원전산업과 문화관광 자원이 풍부합니다. 농촌 지역의 인구 소멸이 심각한 상황입니다.',
    sub_regions_count: 23,
    extinction_risk: '위험',
  },
  {
    id: 'gyeongnam',
    ...
    debt: 1.8,
    debt_ratio: 13.0,
    fiscal_independence: 28.2,
    fiscal_self_reliance: 47.5,
    governor: '박완수',
    governor_party: '국민의힘',
    key_issues: ['조선·항공 산업 혁신', '진주혁신도시 활성화', '낙동강 수질 관리', '농촌 인구 유지'],
    description: '조선·항공·방위산업의 중심지. 거제·창원·진해의 산업 인프라가 강점이지만, 조선업 경기 변동에 따른 지역경제 불안정성과 서부 농촌 지역의 인구 감소가 과제입니다.',
    sub_regions_count: 18,
    extinction_risk: '관심',
  },
  {
    ...
    debt: 1.2,
    debt_ratio: 21.8,
    fiscal_independence: 28.8,
    fiscal_self_reliance: 45.5,
    governor: '오영훈',
    governor_party: '더불어민주당',
    key_issues: ['관광산업 질적 전환', '환경보전 vs 개발', '제2공항 갈등', '외국인 투자 관리', '물 부족 대응'],
    description: '대한민국 최대 관광지이자 유네스코 자연유산. 연간 1,500만 명 이상의 관광객이 방문하지만, 환경 훼손과 오버투어리즘, 제2공항 건설 갈등이 핵심 과제입니다.',
    sub_regions_count: 2,
  },
];
...
export function getLocalGovernments(): LocalGovernment[] {
  return LOCAL_GOVERNMENTS_DATA;
}

export function getLocalGovernmentById(id: string): LocalGovernment | undefined {
  return LOCAL_GOVERNMENTS_DATA.find(lg => lg.id === id);
}

export function getLocalGovernmentNationalAvgFiscalIndependence(): number {
  const total = LOCAL_GOVERNMENTS_DATA.reduce((sum, lg) => sum + lg.fiscal_independence, 0);
  return Math.round((total / LOCAL_GOVERNMENTS_DATA.length) * 10) / 10;
}
